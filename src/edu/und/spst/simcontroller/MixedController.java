package edu.und.spst.simcontroller;
...
public class MixedController extends AController {
	...
	private float levelToKeepO2At = 0.33f;

	private float levelToKeepCO2At = 0.00333f;
	...
	private GenericActuator myBiomassPSPowerActuator;

	private float myBiomassPSPowerRateValue;
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 40000; i += 1000) {
			myController.setCurrentBiomassPSPowerInflowRateValue(i);
			myController.runSim();
	...
	private void collectReferences() {
		...
		/* No present in ths version of Biosim
       ...
       */
		...
		myBiomassPSPowerActuator = (GenericActuator) myBioHolder
	...
	public void stepSim() {
		...
		doO2Injector();
		setBiomassPSPowerInFlowRateValue();
		if (myCO2Injector != null)
			doCO2Injector();
	...
	public void setBiomassPSPowerInFlowRateValue() {
		myBiomassPSPowerActuator.setValue(myBiomassPSPowerRateValue);
	}

	public void setCurrentBiomassPSPowerInflowRateValue(
			float pBiomassInflowRateVal) {
		myBiomassPSPowerRateValue = pBiomassInflowRateVal;
	}
