...
/**
 * @author Theresa Klein, Scott Bell (modified original code) - edu.rice.biosim.RL.disaster
 * @author Curt Holmer - Modified for UND Thesis work
 */

public class SimController extends AController {
	// feedback loop stuff
	...
	public SimController(boolean causeMalf, int malfTime) {
		myLogger = Logger.getLogger(this.getClass());
		collectReferences();
		setThresholds();
		continuousState = new StateMap();
	...
	public static void main(String[] args) {
		SimController myController = new SimController();
		myController.runSim();
	}
	...
	private void collectReferences() {
		...
		/* not present in current version of Biosim
