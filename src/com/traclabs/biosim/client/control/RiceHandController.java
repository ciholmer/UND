 ...
 *
 * from https://github.com/scottbell/reinforcement-learning-biosim/blob/master/src/edu/rice/biosim/RL/disaster/HandController.java
 * Original controller code for testing
 */

public class RiceHandController implements BiosimController{
    ...
    private String myXmlFilename; //CIH 201116
    ...
    public RiceHandController(String xmlFileName) {    //CIH 201116 Add xmlFilename
    	this.myXmlFilename = xmlFileName;
        myLogger = Logger.getLogger(this.getClass());
        setThresholds();
        continuousState = new StateMap();
        myActionMap = new ActionMap(myXmlFilename);       //CIH 201116 add xmlFIleName
    ...
    public static void main(String[] args) {
    	//CIH 201116 add xml file argument code
    	...
    	RiceHandController myController = new RiceHandController(filename); //CIH 200116 Added xml config file name, change from HandController to RiceHandController
