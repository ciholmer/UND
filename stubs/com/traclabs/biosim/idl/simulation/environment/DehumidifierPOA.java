...
public abstract class DehumidifierPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.DehumidifierOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getDirtyWaterProducerDefinition", new java.lang.Integer(22));
	...
	public com.traclabs.biosim.idl.simulation.environment.Dehumidifier _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.environment.DehumidifierHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 22: // getDirtyWaterProducerDefinition
			{
				_out = handler.createReply();
