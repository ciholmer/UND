...
public class _AirConsumerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.environment.AirConsumerDefinition
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/environment/AirConsumerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.environment.AirConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			AirConsumerDefinitionOperations _localServant = (AirConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setAirInputs(com.traclabs.biosim.idl.simulation.environment.SimEnvironment[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setAirInputs", true);
				com.traclabs.biosim.idl.simulation.environment.SimEnvironmentListHelper.write(_os,sources);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setAirInputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			AirConsumerDefinitionOperations _localServant = (AirConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setAirInputs(sources,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
