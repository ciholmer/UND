...
public class _EnvironmentFlowRateControllableStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.environment.EnvironmentFlowRateControllable
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.environment.EnvironmentFlowRateControllableOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			EnvironmentFlowRateControllableOperations _localServant = (EnvironmentFlowRateControllableOperations)_so.servant;
			float _result;			try
			{
