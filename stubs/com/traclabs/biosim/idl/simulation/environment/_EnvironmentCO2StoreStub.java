...
public class _EnvironmentCO2StoreStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.environment.EnvironmentCO2Store
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentCO2Store:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SimBioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentStore:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/PassiveModule:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/air/CO2Store:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Store:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.environment.EnvironmentCO2StoreOperations.class;
	public void setPipe(boolean pPipe)
	{
		...
		else
		{
			...
			EnvironmentCO2StoreOperations _localServant = (EnvironmentCO2StoreOperations)_so.servant;
			try
			{
	...
	public float getInitialPressure()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getInitialPressure", true);
				_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getInitialPressure", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			EnvironmentCO2StoreOperations _localServant = (EnvironmentCO2StoreOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.getInitialPressure();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public float getPressure()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getPressure", true);
				_is = _invoke(_os);
				float _result = _is.read_float();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getPressure", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			EnvironmentCO2StoreOperations _localServant = (EnvironmentCO2StoreOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.getPressure();
			}
			finally
			{
				_servant_postinvoke(_so);
