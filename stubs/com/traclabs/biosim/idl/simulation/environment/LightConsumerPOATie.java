...
public class LightConsumerPOATie
	extends LightConsumerPOA
{
	private LightConsumerOperations _delegate;

	private POA _poa;
	public LightConsumerPOATie(LightConsumerOperations delegate)
	{
		_delegate = delegate;
	}
	public LightConsumerPOATie(LightConsumerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public LightConsumerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(LightConsumerOperations delegate)
	{
		_delegate = delegate;
	}
