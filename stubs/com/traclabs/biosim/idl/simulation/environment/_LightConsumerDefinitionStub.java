...
public class _LightConsumerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.environment.LightConsumerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.environment.LightConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			LightConsumerDefinitionOperations _localServant = (LightConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setLightInput(com.traclabs.biosim.idl.simulation.environment.SimEnvironment source)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setLightInput", true);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setLightInput", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			LightConsumerDefinitionOperations _localServant = (LightConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setLightInput(source);
			}
			finally
			{
				_servant_postinvoke(_so);
