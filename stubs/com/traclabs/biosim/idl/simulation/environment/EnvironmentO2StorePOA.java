...
public abstract class EnvironmentO2StorePOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.EnvironmentO2StoreOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "setPipe", new java.lang.Integer(0));
		m_opsHash.put ( "getInitialPressure", new java.lang.Integer(1));
		m_opsHash.put ( "setCurrentLevel", new java.lang.Integer(2));
		m_opsHash.put ( "clearMalfunction", new java.lang.Integer(3));
		m_opsHash.put ( "getTickLength", new java.lang.Integer(4));
		m_opsHash.put ( "fixAllMalfunctions", new java.lang.Integer(5));
		...
		m_opsHash.put ( "registerBioCommandListener", new java.lang.Integer(17));
		...
		m_opsHash.put ( "getInitialLevel", new java.lang.Integer(33));
		m_opsHash.put ( "setEnableFailure", new java.lang.Integer(34));
	...
	public com.traclabs.biosim.idl.simulation.environment.EnvironmentO2Store _this()
	{
		return com.traclabs.biosim.idl.simulation.environment.EnvironmentO2StoreHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.environment.EnvironmentO2Store _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.environment.EnvironmentO2StoreHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 1: // getInitialPressure
			{
				_out = handler.createReply();
				_out.write_float(getInitialPressure());
				break;
			}
			...
			case 4: // getTickLength
			{
				_out = handler.createReply();
				_out.write_float(getTickLength());
				break;
			}
			case 5: // fixAllMalfunctions
			{
				_out = handler.createReply();
				fixAllMalfunctions();
				break;
			...
			case 17: // registerBioCommandListener
			{
			...
			case 33: // getInitialLevel
			{
				_out = handler.createReply();
				_out.write_float(getInitialLevel());
				break;
			}
			case 34: // setEnableFailure
			{
				boolean _arg0=_input.read_boolean();
				_out = handler.createReply();
