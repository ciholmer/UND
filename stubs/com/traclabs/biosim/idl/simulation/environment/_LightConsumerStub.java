...
public class _LightConsumerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.environment.LightConsumer
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/environment/LightConsumer:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentConsumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.environment.LightConsumerOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			LightConsumerOperations _localServant = (LightConsumerOperations)_so.servant;
			float _result;			try
			{
