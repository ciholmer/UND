...
public final class EnvironmentO2StoreHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentO2Store:1.0", "EnvironmentO2Store");
	}
	...
	public static com.traclabs.biosim.idl.simulation.environment.EnvironmentO2Store narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.simulation.environment.EnvironmentO2Store)
		{
	...
	public static com.traclabs.biosim.idl.simulation.environment.EnvironmentO2Store narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentO2Store:1.0"))
			{
