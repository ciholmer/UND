...
public class EnvironmentO2StorePOATie
	extends EnvironmentO2StorePOA
{
	private EnvironmentO2StoreOperations _delegate;

	private POA _poa;
	public EnvironmentO2StorePOATie(EnvironmentO2StoreOperations delegate)
	{
		_delegate = delegate;
	}
	public EnvironmentO2StorePOATie(EnvironmentO2StoreOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public EnvironmentO2StoreOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(EnvironmentO2StoreOperations delegate)
	{
		_delegate = delegate;
	}
