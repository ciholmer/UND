...
public class EnvironmentVaporStorePOATie
	extends EnvironmentVaporStorePOA
{
	private EnvironmentVaporStoreOperations _delegate;

	private POA _poa;
	public EnvironmentVaporStorePOATie(EnvironmentVaporStoreOperations delegate)
	{
		_delegate = delegate;
	}
	public EnvironmentVaporStorePOATie(EnvironmentVaporStoreOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public EnvironmentVaporStoreOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(EnvironmentVaporStoreOperations delegate)
	{
		_delegate = delegate;
	}
