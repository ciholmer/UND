...
public class DehumidifierPOATie
	extends DehumidifierPOA
{
	private DehumidifierOperations _delegate;

	private POA _poa;
	public DehumidifierPOATie(DehumidifierOperations delegate)
	{
		_delegate = delegate;
	}
	public DehumidifierPOATie(DehumidifierOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public DehumidifierOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(DehumidifierOperations delegate)
	{
		_delegate = delegate;
	}
