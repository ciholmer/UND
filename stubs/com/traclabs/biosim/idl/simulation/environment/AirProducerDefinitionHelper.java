...
public final class AirProducerDefinitionHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/environment/AirProducerDefinition:1.0", "AirProducerDefinition");
	}
	...
	public static com.traclabs.biosim.idl.simulation.environment.AirProducerDefinition narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.simulation.environment.AirProducerDefinition)
		{
	...
	public static com.traclabs.biosim.idl.simulation.environment.AirProducerDefinition narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/environment/AirProducerDefinition:1.0"))
			{
