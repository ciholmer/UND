...
public class _EnvironmentOtherStoreStub
	...
	implements com.traclabs.biosim.idl.simulation.environment.EnvironmentOtherStore
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.environment.EnvironmentOtherStoreOperations.class;
	public void setPipe(boolean pPipe)
	{
		...
		else
		{
			...
			EnvironmentOtherStoreOperations _localServant = (EnvironmentOtherStoreOperations)_so.servant;
			try
			{
