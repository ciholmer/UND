...
public final class StoreEnvironmentConsumerHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/environment/StoreEnvironmentConsumer:1.0", "StoreEnvironmentConsumer");
	}
	...
	public static com.traclabs.biosim.idl.simulation.environment.StoreEnvironmentConsumer narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.simulation.environment.StoreEnvironmentConsumer)
		{
	...
	public static com.traclabs.biosim.idl.simulation.environment.StoreEnvironmentConsumer narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/environment/StoreEnvironmentConsumer:1.0"))
			{
