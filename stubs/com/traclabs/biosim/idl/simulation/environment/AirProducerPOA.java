...
public abstract class AirProducerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.AirProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getAirProducerDefinition", new java.lang.Integer(15));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 15: // getAirProducerDefinition
			{
				_out = handler.createReply();
