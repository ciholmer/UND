...
public abstract class AirConsumerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.AirConsumerDefinitionOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "getPercentageFull", new java.lang.Integer(0));
		m_opsHash.put ( "setAirInputs", new java.lang.Integer(1));
		m_opsHash.put ( "getActualFlowRates", new java.lang.Integer(2));
		m_opsHash.put ( "getMaxFlowRates", new java.lang.Integer(3));
		m_opsHash.put ( "reset", new java.lang.Integer(4));
		m_opsHash.put ( "setInitialDesiredFlowRates", new java.lang.Integer(5));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 1: // setAirInputs
			{
				...
				_out = handler.createReply();
				setAirInputs(_arg0,_arg1,_arg2);
				break;
			}
			case 2: // getActualFlowRates
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.FloatListHelper.write(_out,getActualFlowRates());
				break;
			}
			case 3: // getMaxFlowRates
			{
				_out = handler.createReply();
			...
			case 5: // setInitialDesiredFlowRates
			{
