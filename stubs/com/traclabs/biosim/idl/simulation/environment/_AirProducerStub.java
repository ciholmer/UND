...
public class _AirProducerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.environment.AirProducer
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/environment/AirProducer:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentProducer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.environment.AirProducerOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			AirProducerOperations _localServant = (AirProducerOperations)_so.servant;
			float _result;			try
			{
