...
public class EnvironmentStorePOATie
	extends EnvironmentStorePOA
{
	private EnvironmentStoreOperations _delegate;

	private POA _poa;
	public EnvironmentStorePOATie(EnvironmentStoreOperations delegate)
	{
		_delegate = delegate;
	}
	public EnvironmentStorePOATie(EnvironmentStoreOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public EnvironmentStoreOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(EnvironmentStoreOperations delegate)
	{
		_delegate = delegate;
	}
