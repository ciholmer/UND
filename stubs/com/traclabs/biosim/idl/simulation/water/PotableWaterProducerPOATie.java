...
public class PotableWaterProducerPOATie
	extends PotableWaterProducerPOA
{
	private PotableWaterProducerOperations _delegate;

	private POA _poa;
	public PotableWaterProducerPOATie(PotableWaterProducerOperations delegate)
	{
		_delegate = delegate;
	}
	public PotableWaterProducerPOATie(PotableWaterProducerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public PotableWaterProducerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(PotableWaterProducerOperations delegate)
	{
		_delegate = delegate;
	}
