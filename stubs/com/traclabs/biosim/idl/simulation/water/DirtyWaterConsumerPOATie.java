...
public class DirtyWaterConsumerPOATie
	extends DirtyWaterConsumerPOA
{
	private DirtyWaterConsumerOperations _delegate;

	private POA _poa;
	public DirtyWaterConsumerPOATie(DirtyWaterConsumerOperations delegate)
	{
		_delegate = delegate;
	}
	public DirtyWaterConsumerPOATie(DirtyWaterConsumerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerHelper.narrow(_this_object(orb));
	}
	public DirtyWaterConsumerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(DirtyWaterConsumerOperations delegate)
	{
		_delegate = delegate;
	}
