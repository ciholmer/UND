...
public class _DirtyWaterConsumerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerDefinition
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/DirtyWaterConsumerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/water/WaterConsumerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			DirtyWaterConsumerDefinitionOperations _localServant = (DirtyWaterConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setDirtyWaterInputs(com.traclabs.biosim.idl.simulation.water.DirtyWaterStore[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setDirtyWaterInputs", true);
				com.traclabs.biosim.idl.simulation.water.DirtyWaterStoreListHelper.write(_os,sources);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setDirtyWaterInputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			DirtyWaterConsumerDefinitionOperations _localServant = (DirtyWaterConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setDirtyWaterInputs(sources,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
