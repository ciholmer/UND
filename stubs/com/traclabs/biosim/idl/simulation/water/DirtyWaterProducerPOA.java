...
public abstract class DirtyWaterProducerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getDirtyWaterProducerDefinition", new java.lang.Integer(20));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/DirtyWaterProducer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0"};
	public com.traclabs.biosim.idl.simulation.water.DirtyWaterProducer _this()
	{
		return com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.water.DirtyWaterProducer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 20: // getDirtyWaterProducerDefinition
			{
				_out = handler.createReply();
