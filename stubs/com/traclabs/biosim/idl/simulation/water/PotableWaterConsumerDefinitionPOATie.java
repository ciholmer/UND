...
public class PotableWaterConsumerDefinitionPOATie
	extends PotableWaterConsumerDefinitionPOA
{
	private PotableWaterConsumerDefinitionOperations _delegate;

	private POA _poa;
	public PotableWaterConsumerDefinitionPOATie(PotableWaterConsumerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
	public PotableWaterConsumerDefinitionPOATie(PotableWaterConsumerDefinitionOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public PotableWaterConsumerDefinitionOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(PotableWaterConsumerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.setInitialStores(pStores);
	...
	{
_delegate.setPotableWaterInputs(sources,maxFlowRates,desiredFlowRates);
	}
