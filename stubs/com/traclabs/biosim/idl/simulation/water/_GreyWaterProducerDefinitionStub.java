...
public class _GreyWaterProducerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.water.GreyWaterProducerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.water.GreyWaterProducerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			GreyWaterProducerDefinitionOperations _localServant = (GreyWaterProducerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setGreyWaterOutputs(com.traclabs.biosim.idl.simulation.water.GreyWaterStore[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setGreyWaterOutputs", true);
				com.traclabs.biosim.idl.simulation.water.GreyWaterStoreListHelper.write(_os,destinations);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setGreyWaterOutputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			GreyWaterProducerDefinitionOperations _localServant = (GreyWaterProducerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setGreyWaterOutputs(destinations,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
