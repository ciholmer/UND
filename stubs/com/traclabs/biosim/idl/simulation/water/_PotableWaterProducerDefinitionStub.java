...
public class _PotableWaterProducerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.water.PotableWaterProducerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.water.PotableWaterProducerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			PotableWaterProducerDefinitionOperations _localServant = (PotableWaterProducerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setPotableWaterOutputs(com.traclabs.biosim.idl.simulation.water.PotableWaterStore[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setPotableWaterOutputs", true);
				com.traclabs.biosim.idl.simulation.water.PotableWaterStoreListHelper.write(_os,destinations);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setPotableWaterOutputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			PotableWaterProducerDefinitionOperations _localServant = (PotableWaterProducerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setPotableWaterOutputs(destinations,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
