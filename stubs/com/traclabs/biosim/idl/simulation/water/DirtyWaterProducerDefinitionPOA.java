...
public abstract class DirtyWaterProducerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setDirtyWaterOutputs", new java.lang.Integer(15));
	...
	{
		return com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerDefinitionHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerDefinition _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerDefinitionHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 15: // setDirtyWaterOutputs
			{
				com.traclabs.biosim.idl.simulation.water.DirtyWaterStore[] _arg0=com.traclabs.biosim.idl.simulation.water.DirtyWaterStoreListHelper.read(_input);
				...
				_out = handler.createReply();
				setDirtyWaterOutputs(_arg0,_arg1,_arg2);
				break;
			}
			case 16: // connectsTo
			{
