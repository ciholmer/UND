...
public final class DirtyWaterProducerHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/water/DirtyWaterProducer:1.0", "DirtyWaterProducer");
	}
	...
	public static com.traclabs.biosim.idl.simulation.water.DirtyWaterProducer narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.simulation.water.DirtyWaterProducer)
		{
	...
	public static com.traclabs.biosim.idl.simulation.water.DirtyWaterProducer narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/water/DirtyWaterProducer:1.0"))
			{
