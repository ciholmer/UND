...
public abstract class PotableWaterConsumerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setPotableWaterInputs", new java.lang.Integer(4));
		m_opsHash.put ( "getStores", new java.lang.Integer(5));
		m_opsHash.put ( "getMaxFlowRates", new java.lang.Integer(6));
		m_opsHash.put ( "reset", new java.lang.Integer(7));
		m_opsHash.put ( "setInitialDesiredFlowRates", new java.lang.Integer(8));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/PotableWaterConsumerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/water/WaterConsumerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerDefinition _this()
	{
		return com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerDefinitionHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerDefinition _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerDefinitionHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 4: // setPotableWaterInputs
			{
				com.traclabs.biosim.idl.simulation.water.PotableWaterStore[] _arg0=com.traclabs.biosim.idl.simulation.water.PotableWaterStoreListHelper.read(_input);
				...
				_out = handler.createReply();
				setPotableWaterInputs(_arg0,_arg1,_arg2);
				break;
			}
			case 5: // getStores
			{
