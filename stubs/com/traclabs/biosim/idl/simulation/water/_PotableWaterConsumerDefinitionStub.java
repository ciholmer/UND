...
public class _PotableWaterConsumerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			PotableWaterConsumerDefinitionOperations _localServant = (PotableWaterConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setPotableWaterInputs(com.traclabs.biosim.idl.simulation.water.PotableWaterStore[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setPotableWaterInputs", true);
				com.traclabs.biosim.idl.simulation.water.PotableWaterStoreListHelper.write(_os,sources);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setPotableWaterInputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			PotableWaterConsumerDefinitionOperations _localServant = (PotableWaterConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setPotableWaterInputs(sources,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
