...
public class WaterConsumerPOATie
	extends WaterConsumerPOA
{
	private WaterConsumerOperations _delegate;

	private POA _poa;
	public WaterConsumerPOATie(WaterConsumerOperations delegate)
	{
		_delegate = delegate;
	}
	public WaterConsumerPOATie(WaterConsumerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	{
		return com.traclabs.biosim.idl.simulation.water.WaterConsumerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.water.WaterConsumer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.water.WaterConsumerHelper.narrow(_this_object(orb));
	}
	public WaterConsumerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(WaterConsumerOperations delegate)
	{
		_delegate = delegate;
	}
