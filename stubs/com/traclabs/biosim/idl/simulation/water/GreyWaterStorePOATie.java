...
public class GreyWaterStorePOATie
	extends GreyWaterStorePOA
{
	private GreyWaterStoreOperations _delegate;

	private POA _poa;
	public GreyWaterStorePOATie(GreyWaterStoreOperations delegate)
	{
		_delegate = delegate;
	}
	public GreyWaterStorePOATie(GreyWaterStoreOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public GreyWaterStoreOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(GreyWaterStoreOperations delegate)
	{
		_delegate = delegate;
	}
