...
public class _DirtyWaterProducerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerDefinition
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/DirtyWaterProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/water/WaterProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			DirtyWaterProducerDefinitionOperations _localServant = (DirtyWaterProducerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setDirtyWaterOutputs(com.traclabs.biosim.idl.simulation.water.DirtyWaterStore[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setDirtyWaterOutputs", true);
				com.traclabs.biosim.idl.simulation.water.DirtyWaterStoreListHelper.write(_os,destinations);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setDirtyWaterOutputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			DirtyWaterProducerDefinitionOperations _localServant = (DirtyWaterProducerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setDirtyWaterOutputs(destinations,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
