...
public class _WaterConsumerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.water.WaterConsumerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.water.WaterConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			WaterConsumerDefinitionOperations _localServant = (WaterConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
