...
public class DirtyWaterProducerPOATie
	extends DirtyWaterProducerPOA
{
	private DirtyWaterProducerOperations _delegate;

	private POA _poa;
	public DirtyWaterProducerPOATie(DirtyWaterProducerOperations delegate)
	{
		_delegate = delegate;
	}
	public DirtyWaterProducerPOATie(DirtyWaterProducerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public DirtyWaterProducerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(DirtyWaterProducerOperations delegate)
	{
		_delegate = delegate;
	}
