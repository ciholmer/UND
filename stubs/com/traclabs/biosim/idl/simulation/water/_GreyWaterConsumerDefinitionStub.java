...
public class _GreyWaterConsumerDefinitionStub
	...
	implements com.traclabs.biosim.idl.simulation.water.GreyWaterConsumerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.water.GreyWaterConsumerDefinitionOperations.class;
	...
	public void setGreyWaterInputs(com.traclabs.biosim.idl.simulation.water.GreyWaterStore[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setGreyWaterInputs", true);
				com.traclabs.biosim.idl.simulation.water.GreyWaterStoreListHelper.write(_os,sources);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setGreyWaterInputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			GreyWaterConsumerDefinitionOperations _localServant = (GreyWaterConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setGreyWaterInputs(sources,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
