...
public abstract class GreyWaterConsumerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.GreyWaterConsumerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setGreyWaterInputs", new java.lang.Integer(6));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 6: // setGreyWaterInputs
			{
				...
				_out = handler.createReply();
				setGreyWaterInputs(_arg0,_arg1,_arg2);
				break;
			}
			case 7: // reset
			{
