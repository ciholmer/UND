...
public class GreyWaterProducerPOATie
	extends GreyWaterProducerPOA
{
	private GreyWaterProducerOperations _delegate;

	private POA _poa;
	public GreyWaterProducerPOATie(GreyWaterProducerOperations delegate)
	{
		_delegate = delegate;
	}
	public GreyWaterProducerPOATie(GreyWaterProducerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public GreyWaterProducerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(GreyWaterProducerOperations delegate)
	{
		_delegate = delegate;
	}
