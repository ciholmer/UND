...
public class PotableWaterProducerDefinitionPOATie
	extends PotableWaterProducerDefinitionPOA
{
	private PotableWaterProducerDefinitionOperations _delegate;

	private POA _poa;
	public PotableWaterProducerDefinitionPOATie(PotableWaterProducerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
	public PotableWaterProducerDefinitionPOATie(PotableWaterProducerDefinitionOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public PotableWaterProducerDefinitionOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(PotableWaterProducerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.setInitialMaxFlowRates(flowrates);
	...
	{
_delegate.setPotableWaterOutputs(destinations,maxFlowRates,desiredFlowRates);
	}
