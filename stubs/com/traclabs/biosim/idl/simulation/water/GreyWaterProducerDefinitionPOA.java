...
public abstract class GreyWaterProducerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.GreyWaterProducerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setGreyWaterOutputs", new java.lang.Integer(3));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/GreyWaterProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/water/WaterProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 3: // setGreyWaterOutputs
			{
				com.traclabs.biosim.idl.simulation.water.GreyWaterStore[] _arg0=com.traclabs.biosim.idl.simulation.water.GreyWaterStoreListHelper.read(_input);
				...
				_out = handler.createReply();
				setGreyWaterOutputs(_arg0,_arg1,_arg2);
				break;
			}
