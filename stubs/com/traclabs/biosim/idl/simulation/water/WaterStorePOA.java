...
public abstract class WaterStorePOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.WaterStoreOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "scheduleMalfunction", new java.lang.Integer(39));
		m_opsHash.put ( "getMalfunctionNames", new java.lang.Integer(40));
		m_opsHash.put ( "isFailureEnabled", new java.lang.Integer(41));
	}
	...
	public com.traclabs.biosim.idl.simulation.water.WaterStore _this()
	{
		return com.traclabs.biosim.idl.simulation.water.WaterStoreHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.water.WaterStore _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.water.WaterStoreHelper.narrow(_this_object(orb));
	}
