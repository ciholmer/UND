...
public abstract class GreyWaterProducerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.GreyWaterProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getGreyWaterProducerDefinition", new java.lang.Integer(3));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/GreyWaterProducer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0"};
	public com.traclabs.biosim.idl.simulation.water.GreyWaterProducer _this()
	{
		return com.traclabs.biosim.idl.simulation.water.GreyWaterProducerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.water.GreyWaterProducer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.water.GreyWaterProducerHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 3: // getGreyWaterProducerDefinition
			{
				_out = handler.createReply();
