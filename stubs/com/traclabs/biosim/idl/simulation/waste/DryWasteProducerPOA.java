...
public abstract class DryWasteProducerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.waste.DryWasteProducerOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "getTickLength", new java.lang.Integer(0));
		m_opsHash.put ( "getDryWasteProducerDefinition", new java.lang.Integer(1));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/waste/DryWasteProducer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0"};
	public com.traclabs.biosim.idl.simulation.waste.DryWasteProducer _this()
	{
		return com.traclabs.biosim.idl.simulation.waste.DryWasteProducerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.waste.DryWasteProducer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.waste.DryWasteProducerHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 1: // getDryWasteProducerDefinition
			{
				_out = handler.createReply();
