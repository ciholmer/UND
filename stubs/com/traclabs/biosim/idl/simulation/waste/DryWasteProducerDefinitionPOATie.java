...
public class DryWasteProducerDefinitionPOATie
	extends DryWasteProducerDefinitionPOA
{
	private DryWasteProducerDefinitionOperations _delegate;

	private POA _poa;
	public DryWasteProducerDefinitionPOATie(DryWasteProducerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
	public DryWasteProducerDefinitionPOATie(DryWasteProducerDefinitionOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public DryWasteProducerDefinitionOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(DryWasteProducerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.setInitialActualFlowRates(flowrates);
	...
	{
_delegate.setDryWasteOutputs(destinations,maxFlowRates,desiredFlowRates);
	}
