...
public class _DryWasteConsumerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.waste.DryWasteConsumer
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/waste/DryWasteConsumer:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.waste.DryWasteConsumerOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			DryWasteConsumerOperations _localServant = (DryWasteConsumerOperations)_so.servant;
			float _result;			try
			{
