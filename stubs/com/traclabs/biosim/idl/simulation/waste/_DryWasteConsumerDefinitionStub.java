...
public class _DryWasteConsumerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.waste.DryWasteConsumerDefinition
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/waste/DryWasteConsumerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.waste.DryWasteConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			DryWasteConsumerDefinitionOperations _localServant = (DryWasteConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setDryWasteInputs(com.traclabs.biosim.idl.simulation.waste.DryWasteStore[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setDryWasteInputs", true);
				com.traclabs.biosim.idl.simulation.waste.DryWasteStoreListHelper.write(_os,sources);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setDryWasteInputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			DryWasteConsumerDefinitionOperations _localServant = (DryWasteConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setDryWasteInputs(sources,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
