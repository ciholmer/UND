...
public abstract class DryWasteProducerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.waste.DryWasteProducerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setDryWasteOutputs", new java.lang.Integer(12));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/waste/DryWasteProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public com.traclabs.biosim.idl.simulation.waste.DryWasteProducerDefinition _this()
	{
		return com.traclabs.biosim.idl.simulation.waste.DryWasteProducerDefinitionHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.waste.DryWasteProducerDefinition _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.waste.DryWasteProducerDefinitionHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 12: // setDryWasteOutputs
			{
				com.traclabs.biosim.idl.simulation.waste.DryWasteStore[] _arg0=com.traclabs.biosim.idl.simulation.waste.DryWasteStoreListHelper.read(_input);
				...
				_out = handler.createReply();
				setDryWasteOutputs(_arg0,_arg1,_arg2);
				break;
			}
