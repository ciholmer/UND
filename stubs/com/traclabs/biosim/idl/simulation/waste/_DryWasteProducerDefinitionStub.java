...
public class _DryWasteProducerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.waste.DryWasteProducerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.waste.DryWasteProducerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			DryWasteProducerDefinitionOperations _localServant = (DryWasteProducerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setDryWasteOutputs(com.traclabs.biosim.idl.simulation.waste.DryWasteStore[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setDryWasteOutputs", true);
				com.traclabs.biosim.idl.simulation.waste.DryWasteStoreListHelper.write(_os,destinations);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setDryWasteOutputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			DryWasteProducerDefinitionOperations _localServant = (DryWasteProducerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setDryWasteOutputs(destinations,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
