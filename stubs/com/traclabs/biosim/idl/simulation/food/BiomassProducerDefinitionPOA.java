...
public abstract class BiomassProducerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.BiomassProducerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setBiomassOutputs", new java.lang.Integer(5));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/food/BiomassProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public com.traclabs.biosim.idl.simulation.food.BiomassProducerDefinition _this()
	{
		return com.traclabs.biosim.idl.simulation.food.BiomassProducerDefinitionHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.food.BiomassProducerDefinition _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.food.BiomassProducerDefinitionHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 5: // setBiomassOutputs
			{
				com.traclabs.biosim.idl.simulation.food.BiomassStore[] _arg0=com.traclabs.biosim.idl.simulation.food.BiomassStoreListHelper.read(_input);
				...
				_out = handler.createReply();
				setBiomassOutputs(_arg0,_arg1,_arg2);
				break;
			}
