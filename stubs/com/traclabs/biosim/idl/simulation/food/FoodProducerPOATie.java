...
public class FoodProducerPOATie
	extends FoodProducerPOA
{
	private FoodProducerOperations _delegate;

	private POA _poa;
	public FoodProducerPOATie(FoodProducerOperations delegate)
	{
		_delegate = delegate;
	}
	public FoodProducerPOATie(FoodProducerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public FoodProducerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(FoodProducerOperations delegate)
	{
		_delegate = delegate;
	}
