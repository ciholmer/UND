...
public class BiomassProducerDefinitionPOATie
	extends BiomassProducerDefinitionPOA
{
	private BiomassProducerDefinitionOperations _delegate;

	private POA _poa;
	public BiomassProducerDefinitionPOATie(BiomassProducerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
	public BiomassProducerDefinitionPOATie(BiomassProducerDefinitionOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public BiomassProducerDefinitionOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(BiomassProducerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.setInitialStores(pStores);
	...
	{
_delegate.setBiomassOutputs(destinations,maxFlowRates,desiredFlowRates);
	}
