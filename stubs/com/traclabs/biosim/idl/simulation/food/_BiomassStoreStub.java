...
public class _BiomassStoreStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.food.BiomassStore
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/food/BiomassStore:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SimBioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/PassiveModule:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Store:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.food.BiomassStoreOperations.class;
	public float addBioMatter(com.traclabs.biosim.idl.simulation.food.BioMatter pBioMatter)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "addBioMatter", true);
				com.traclabs.biosim.idl.simulation.food.BioMatterHelper.write(_os,pBioMatter);
				_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "addBioMatter", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.addBioMatter(pBioMatter);
			}
			finally
			{
	...
	public void setPipe(boolean pPipe)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setPipe", true);
				_os.write_boolean(pPipe);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setPipe", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			try
			{
			_localServant.setPipe(pPipe);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void setCurrentLevel(float metricAmount)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setCurrentLevel", true);
				_os.write_float(metricAmount);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setCurrentLevel", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			try
			{
			_localServant.setCurrentLevel(metricAmount);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public float calculateWaterContentInStore()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "calculateWaterContentInStore", true);
				_is = _invoke(_os);
				float _result = _is.read_float();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "calculateWaterContentInStore", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.calculateWaterContentInStore();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public float getCurrentCapacity()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getCurrentCapacity", true);
				_is = _invoke(_os);
				float _result = _is.read_float();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getCurrentCapacity", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.getCurrentCapacity();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void setInitialCapacity(float metricAmount)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setInitialCapacity", true);
				_os.write_float(metricAmount);
				_is = _invoke(_os);
				return;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setInitialCapacity", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			try
			{
			_localServant.setInitialCapacity(metricAmount);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public float getInitialCapacity()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getInitialCapacity", true);
				_is = _invoke(_os);
				float _result = _is.read_float();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getInitialCapacity", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.getInitialCapacity();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public float getOverflow()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getOverflow", true);
				_is = _invoke(_os);
				float _result = _is.read_float();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getOverflow", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.getOverflow();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public float take(float metricAmount)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "take", true);
				_os.write_float(metricAmount);
				_is = _invoke(_os);
				float _result = _is.read_float();
				return _result;
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "take", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.take(metricAmount);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public float getPercentageFilled()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getPercentageFilled", true);
				_is = _invoke(_os);
				float _result = _is.read_float();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getPercentageFilled", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.getPercentageFilled();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void setInitialLevel(float metricAmount)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setInitialLevel", true);
				_os.write_float(metricAmount);
				_is = _invoke(_os);
				return;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setInitialLevel", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			try
			{
			_localServant.setInitialLevel(metricAmount);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void setInitialBioMatterLevel(com.traclabs.biosim.idl.simulation.food.BioMatter pBioMatter)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setInitialBioMatterLevel", true);
				com.traclabs.biosim.idl.simulation.food.BioMatterHelper.write(_os,pBioMatter);
				_is = _invoke(_os);
				return;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setInitialBioMatterLevel", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			try
			{
			_localServant.setInitialBioMatterLevel(pBioMatter);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public float getCurrentLevel()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getCurrentLevel", true);
				_is = _invoke(_os);
				float _result = _is.read_float();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getCurrentLevel", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.getCurrentLevel();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void setCurrentCapacity(float metricAmount)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setCurrentCapacity", true);
				_os.write_float(metricAmount);
				_is = _invoke(_os);
				return;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setCurrentCapacity", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			try
			{
			_localServant.setCurrentCapacity(metricAmount);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public com.traclabs.biosim.idl.simulation.food.BioMatter[] takeBioMatterMass(float mass)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "takeBioMatterMass", true);
				_os.write_float(mass);
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.food.BioMatter[] _result = com.traclabs.biosim.idl.simulation.food.BioMatterListHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "takeBioMatterMass", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.BioMatter[] _result;			try
			{
			_result = _localServant.takeBioMatterMass(mass);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public float add(float metricAmount)
	{
		...
		else
		{
			...
			float _result;			try
			{
			_result = _localServant.add(metricAmount);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public boolean isPipe()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "isPipe", true);
				_is = _invoke(_os);
				boolean _result = _is.read_boolean();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "isPipe", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreOperations _localServant = (BiomassStoreOperations)_so.servant;
			boolean _result;			try
			{
			_result = _localServant.isPipe();
			}
			finally
			{
				_servant_postinvoke(_so);
