...
public class BiomassProducerPOATie
	extends BiomassProducerPOA
{
	private BiomassProducerOperations _delegate;

	private POA _poa;
	public BiomassProducerPOATie(BiomassProducerOperations delegate)
	{
		_delegate = delegate;
	}
	public BiomassProducerPOATie(BiomassProducerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public BiomassProducerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(BiomassProducerOperations delegate)
	{
		_delegate = delegate;
	}
