...
public abstract class BiomassConsumerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.BiomassConsumerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setBiomassInputs", new java.lang.Integer(3));
		m_opsHash.put ( "getActualFlowRates", new java.lang.Integer(4));
	...
	public com.traclabs.biosim.idl.simulation.food.BiomassConsumerDefinition _this()
	{
		return com.traclabs.biosim.idl.simulation.food.BiomassConsumerDefinitionHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.food.BiomassConsumerDefinition _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.food.BiomassConsumerDefinitionHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 3: // setBiomassInputs
			{
				...
				_out = handler.createReply();
				setBiomassInputs(_arg0,_arg1,_arg2);
				break;
			}
			case 4: // getActualFlowRates
			{
				_out = handler.createReply();
