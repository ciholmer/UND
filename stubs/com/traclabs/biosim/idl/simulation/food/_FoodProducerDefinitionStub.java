...
public class _FoodProducerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.food.FoodProducerDefinition
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/food/FoodProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.food.FoodProducerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			FoodProducerDefinitionOperations _localServant = (FoodProducerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setFoodOutputs(com.traclabs.biosim.idl.simulation.food.FoodStore[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setFoodOutputs", true);
				com.traclabs.biosim.idl.simulation.food.FoodStoreListHelper.write(_os,destinations);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setFoodOutputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			FoodProducerDefinitionOperations _localServant = (FoodProducerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setFoodOutputs(destinations,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
