...
public abstract class FoodConsumerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.FoodConsumerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setFoodInputs", new java.lang.Integer(6));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/food/FoodConsumerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public com.traclabs.biosim.idl.simulation.food.FoodConsumerDefinition _this()
	{
		return com.traclabs.biosim.idl.simulation.food.FoodConsumerDefinitionHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.food.FoodConsumerDefinition _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.food.FoodConsumerDefinitionHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 6: // setFoodInputs
			{
				com.traclabs.biosim.idl.simulation.food.FoodStore[] _arg0=com.traclabs.biosim.idl.simulation.food.FoodStoreListHelper.read(_input);
				...
				_out = handler.createReply();
				setFoodInputs(_arg0,_arg1,_arg2);
				break;
			}
			case 7: // reset
			{
