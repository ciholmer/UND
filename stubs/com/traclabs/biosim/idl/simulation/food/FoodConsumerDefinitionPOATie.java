...
public class FoodConsumerDefinitionPOATie
	extends FoodConsumerDefinitionPOA
{
	private FoodConsumerDefinitionOperations _delegate;

	private POA _poa;
	public FoodConsumerDefinitionPOATie(FoodConsumerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
	public FoodConsumerDefinitionPOATie(FoodConsumerDefinitionOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public FoodConsumerDefinitionOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(FoodConsumerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.setInitialStores(pStores);
	...
	{
_delegate.setFoodInputs(sources,maxFlowRates,desiredFlowRates);
	}
