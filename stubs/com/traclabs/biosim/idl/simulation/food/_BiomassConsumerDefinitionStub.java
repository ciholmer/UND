...
public class _BiomassConsumerDefinitionStub
	...
	implements com.traclabs.biosim.idl.simulation.food.BiomassConsumerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.food.BiomassConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			BiomassConsumerDefinitionOperations _localServant = (BiomassConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setBiomassInputs(com.traclabs.biosim.idl.simulation.food.BiomassStore[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setBiomassInputs", true);
				com.traclabs.biosim.idl.simulation.food.BiomassStoreListHelper.write(_os,sources);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setBiomassInputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassConsumerDefinitionOperations _localServant = (BiomassConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setBiomassInputs(sources,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
