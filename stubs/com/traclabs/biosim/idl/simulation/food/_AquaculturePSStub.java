	...
	implements com.traclabs.biosim.idl.simulation.food.AquaculturePS
{
	...
	public void clearMalfunction(long id)
	{
		...
		else
		{
			...
			AquaculturePSOperations _localServant = (AquaculturePSOperations)_so.servant;
			try
			{
	...
	public void clearTanks()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "clearTanks", true);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "clearTanks", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			AquaculturePSOperations _localServant = (AquaculturePSOperations)_so.servant;
			try
			{
			_localServant.clearTanks();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void killFish()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "killFish", true);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "killFish", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			AquaculturePSOperations _localServant = (AquaculturePSOperations)_so.servant;
			try
			{
			_localServant.killFish();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public com.traclabs.biosim.idl.simulation.food.Tank createNewTank(com.traclabs.biosim.idl.simulation.food.FishType pType, float pCropArea, int pStartTick)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "createNewTank", true);
				com.traclabs.biosim.idl.simulation.food.FishTypeHelper.write(_os,pType);
				_os.write_float(pCropArea);
				_os.write_long(pStartTick);
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.food.Tank _result = com.traclabs.biosim.idl.simulation.food.TankHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "createNewTank", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			AquaculturePSOperations _localServant = (AquaculturePSOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.Tank _result;			try
			{
			_result = _localServant.createNewTank(pType,pCropArea,pStartTick);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public com.traclabs.biosim.idl.simulation.food.Tank[] getTanks()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getTanks", true);
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.food.Tank[] _result = com.traclabs.biosim.idl.simulation.food.TankListHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getTanks", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			AquaculturePSOperations _localServant = (AquaculturePSOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.Tank[] _result;			try
			{
			_result = _localServant.getTanks();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public boolean isAnyFishDead()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "isAnyFishDead", true);
				_is = _invoke(_os);
				boolean _result = _is.read_boolean();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "isAnyFishDead", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			AquaculturePSOperations _localServant = (AquaculturePSOperations)_so.servant;
			boolean _result;			try
			{
			_result = _localServant.isAnyFishDead();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void setautoHarvestAndRespawnEnabled(boolean pHarvestEnabled)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setautoHarvestAndRespawnEnabled", true);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setautoHarvestAndRespawnEnabled", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			AquaculturePSOperations _localServant = (AquaculturePSOperations)_so.servant;
			try
			{
			_localServant.setautoHarvestAndRespawnEnabled(pHarvestEnabled);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public com.traclabs.biosim.idl.simulation.food.Tank getTank(int index)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getTank", true);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getTank", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			AquaculturePSOperations _localServant = (AquaculturePSOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.Tank _result;			try
			{
			_result = _localServant.getTank(index);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public boolean autoHarvestAndRespawnEnabled()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "autoHarvestAndRespawnEnabled", true);
				_is = _invoke(_os);
				boolean _result = _is.read_boolean();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "autoHarvestAndRespawnEnabled", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			AquaculturePSOperations _localServant = (AquaculturePSOperations)_so.servant;
			boolean _result;			try
			{
			_result = _localServant.autoHarvestAndRespawnEnabled();
			}
			finally
			{
				_servant_postinvoke(_so);
