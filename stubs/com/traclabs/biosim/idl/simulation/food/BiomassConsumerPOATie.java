...
public class BiomassConsumerPOATie
	extends BiomassConsumerPOA
{
	private BiomassConsumerOperations _delegate;

	private POA _poa;
	public BiomassConsumerPOATie(BiomassConsumerOperations delegate)
	{
		_delegate = delegate;
	}
	public BiomassConsumerPOATie(BiomassConsumerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public BiomassConsumerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(BiomassConsumerOperations delegate)
	{
		_delegate = delegate;
	}
