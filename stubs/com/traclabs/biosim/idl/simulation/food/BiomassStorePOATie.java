...
public class BiomassStorePOATie
	extends BiomassStorePOA
{
	private BiomassStoreOperations _delegate;

	private POA _poa;
	public BiomassStorePOATie(BiomassStoreOperations delegate)
	{
		_delegate = delegate;
	}
	public BiomassStorePOATie(BiomassStoreOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	{
		return com.traclabs.biosim.idl.simulation.food.BiomassStoreHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.food.BiomassStore _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.food.BiomassStoreHelper.narrow(_this_object(orb));
	}
	public BiomassStoreOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(BiomassStoreOperations delegate)
	{
		_delegate = delegate;
	}
	...
	{
		return _delegate.addBioMatter(pBioMatter);
	}
...
_delegate.clearMalfunction(id);
	...
	{
		return _delegate.calculateWaterContentInStore();
	}
...
_delegate.maintain();
	...
	{
_delegate.setInitialBioMatterLevel(pBioMatter);
	}
...
_delegate.doSomeRepairWork(id);
	...
	{
		return _delegate.takeBioMatterMass(mass);
	}
