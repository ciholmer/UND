...
public abstract class BiomassConsumerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.BiomassConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getBiomassConsumerDefinition", new java.lang.Integer(15));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/food/BiomassConsumer:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.simulation.food.BiomassConsumer _this()
	{
		return com.traclabs.biosim.idl.simulation.food.BiomassConsumerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.food.BiomassConsumer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.food.BiomassConsumerHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 15: // getBiomassConsumerDefinition
			{
				_out = handler.createReply();
