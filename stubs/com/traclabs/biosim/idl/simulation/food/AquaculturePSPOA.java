...
public abstract class AquaculturePSPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.AquaculturePSOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "clearTanks", new java.lang.Integer(8));
		m_opsHash.put ( "killFish", new java.lang.Integer(9));
		...
		m_opsHash.put ( "createNewTank", new java.lang.Integer(14));
		...
		m_opsHash.put ( "getTanks", new java.lang.Integer(18));
		...
		m_opsHash.put ( "isAnyFishDead", new java.lang.Integer(26));
		m_opsHash.put ( "setautoHarvestAndRespawnEnabled", new java.lang.Integer(27));
		m_opsHash.put ( "getTank", new java.lang.Integer(28));
		...
		m_opsHash.put ( "autoHarvestAndRespawnEnabled", new java.lang.Integer(34));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 14: // createNewTank
			{
				...
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.food.TankHelper.write(_out,createNewTank(_arg0,_arg1,_arg2));
				break;
			}
			case 15: // reset
			{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.food.TankListHelper.write(_out,getTanks());
				break;
			}
			...
			case 26: // isAnyFishDead
			{
				_out = handler.createReply();
				_out.write_boolean(isAnyFishDead());
				break;
			}
			case 27: // setautoHarvestAndRespawnEnabled
			{
				boolean _arg0=_input.read_boolean();
				_out = handler.createReply();
				setautoHarvestAndRespawnEnabled(_arg0);
				break;
			}
			case 28: // getTank
			{
				...
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.food.TankHelper.write(_out,getTank(_arg0));
				break;
			}
			...
			case 34: // autoHarvestAndRespawnEnabled
			{
				_out = handler.createReply();
				_out.write_boolean(autoHarvestAndRespawnEnabled());
				break;
			}
