	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.BiomassStoreOperations
{
	...
	static
	{
		m_opsHash.put ( "addBioMatter", new java.lang.Integer(0));
		m_opsHash.put ( "setPipe", new java.lang.Integer(1));
		m_opsHash.put ( "setCurrentLevel", new java.lang.Integer(2));
		m_opsHash.put ( "clearMalfunction", new java.lang.Integer(3));
		m_opsHash.put ( "calculateWaterContentInStore", new java.lang.Integer(4));
