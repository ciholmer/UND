...
public class BiomassConsumerDefinitionPOATie
	extends BiomassConsumerDefinitionPOA
{
	private BiomassConsumerDefinitionOperations _delegate;

	private POA _poa;
	public BiomassConsumerDefinitionPOATie(BiomassConsumerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
	public BiomassConsumerDefinitionPOATie(BiomassConsumerDefinitionOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public BiomassConsumerDefinitionOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(BiomassConsumerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.setInitialStores(pStores);
	...
	public void setBiomassInputs(com.traclabs.biosim.idl.simulation.food.BiomassStore[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
_delegate.setBiomassInputs(sources,maxFlowRates,desiredFlowRates);
	}
