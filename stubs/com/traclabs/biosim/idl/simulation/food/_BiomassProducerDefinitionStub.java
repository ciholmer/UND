...
public class _BiomassProducerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.food.BiomassProducerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.food.BiomassProducerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			BiomassProducerDefinitionOperations _localServant = (BiomassProducerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setBiomassOutputs(com.traclabs.biosim.idl.simulation.food.BiomassStore[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setBiomassOutputs", true);
				com.traclabs.biosim.idl.simulation.food.BiomassStoreListHelper.write(_os,destinations);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setBiomassOutputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassProducerDefinitionOperations _localServant = (BiomassProducerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setBiomassOutputs(destinations,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
