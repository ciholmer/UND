...
public class _FoodConsumerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.food.FoodConsumerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.food.FoodConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			FoodConsumerDefinitionOperations _localServant = (FoodConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setFoodInputs(com.traclabs.biosim.idl.simulation.food.FoodStore[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setFoodInputs", true);
				com.traclabs.biosim.idl.simulation.food.FoodStoreListHelper.write(_os,sources);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setFoodInputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			FoodConsumerDefinitionOperations _localServant = (FoodConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setFoodInputs(sources,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
