...
public abstract class FoodConsumerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.FoodConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getFoodConsumerDefinition", new java.lang.Integer(10));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/food/FoodConsumer:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.simulation.food.FoodConsumer _this()
	{
		return com.traclabs.biosim.idl.simulation.food.FoodConsumerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.food.FoodConsumer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.food.FoodConsumerHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 10: // getFoodConsumerDefinition
			{
				_out = handler.createReply();
