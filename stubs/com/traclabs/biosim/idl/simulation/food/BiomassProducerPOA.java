...
public abstract class BiomassProducerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.BiomassProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getBiomassProducerDefinition", new java.lang.Integer(14));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/food/BiomassProducer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0"};
	public com.traclabs.biosim.idl.simulation.food.BiomassProducer _this()
	{
		return com.traclabs.biosim.idl.simulation.food.BiomassProducerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.food.BiomassProducer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.food.BiomassProducerHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 14: // getBiomassProducerDefinition
			{
				_out = handler.createReply();
