	...
	implements com.traclabs.biosim.idl.simulation.food.Shelf
{
	...
	public float getCropO2Produced()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getCropO2Produced", true);
				_is = _invoke(_os);
				float _result = _is.read_float();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getCropO2Produced", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			ShelfOperations _localServant = (ShelfOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.getCropO2Produced();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public float getCropCO2Consumed()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getCropCO2Consumed", true);
				_is = _invoke(_os);
				float _result = _is.read_float();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getCropCO2Consumed", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			ShelfOperations _localServant = (ShelfOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.getCropCO2Consumed();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public float getCropWaterConsumed()
		{
			...
			if(! this._is_local())
			{
				...
				try
				{
					org.omg.CORBA.portable.OutputStream _os = _request( "getCropWaterConsumed", true);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
				}
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getCropWaterConsumed", _opsClass );
				if( _so == null )
					throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
				ShelfOperations _localServant = (ShelfOperations)_so.servant;
				float _result;			try
				{
				_result = _localServant.getCropWaterConsumed();
				}
				finally
				{
					_servant_postinvoke(_so);
	...
	public float getCropWaterProduced()
			{
				...
				if(! this._is_local())
				{
					...
					try
					{
						org.omg.CORBA.portable.OutputStream _os = _request( "getCropWaterProduced", true);
						_is = _invoke(_os);
						float _result = _is.read_float();
						return _result;
					}
				...
				{
					org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getCropWaterProduced", _opsClass );
					if( _so == null )
						throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
					ShelfOperations _localServant = (ShelfOperations)_so.servant;
					float _result;			try
					{
					_result = _localServant.getCropWaterProduced();
					}
					finally
					{
						_servant_postinvoke(_so);
