...
public abstract class FoodProducerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.FoodProducerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setFoodOutputs", new java.lang.Integer(8));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 8: // setFoodOutputs
			{
				...
				_out = handler.createReply();
				setFoodOutputs(_arg0,_arg1,_arg2);
				break;
			}
