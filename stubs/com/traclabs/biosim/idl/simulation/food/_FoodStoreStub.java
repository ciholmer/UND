...
public class _FoodStoreStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.food.FoodStore
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.food.FoodStoreOperations.class;
	public void setPipe(boolean pPipe)
	{
		...
		else
		{
			...
			FoodStoreOperations _localServant = (FoodStoreOperations)_so.servant;
			try
			{
	...
	public com.traclabs.biosim.idl.simulation.food.FoodMatter[] takeFoodMatterCalories(float calories, float limitingMass)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "takeFoodMatterCalories", true);
				_os.write_float(calories);
				_os.write_float(limitingMass);
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.food.FoodMatter[] _result = com.traclabs.biosim.idl.simulation.food.FoodMatterListHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "takeFoodMatterCalories", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			FoodStoreOperations _localServant = (FoodStoreOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.FoodMatter[] _result;			try
			{
			_result = _localServant.takeFoodMatterCalories(calories,limitingMass);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public float addFoodMatterArray(com.traclabs.biosim.idl.simulation.food.FoodMatter[] pList)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "addFoodMatterArray", true);
				com.traclabs.biosim.idl.simulation.food.FoodMatterListHelper.write(_os,pList);
				_is = _invoke(_os);
				float _result = _is.read_float();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "addFoodMatterArray", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			FoodStoreOperations _localServant = (FoodStoreOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.addFoodMatterArray(pList);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public float addFoodMatterMass(com.traclabs.biosim.idl.simulation.food.FoodMatter pMatter)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "addFoodMatterMass", true);
				com.traclabs.biosim.idl.simulation.food.FoodMatterHelper.write(_os,pMatter);
				_is = _invoke(_os);
				float _result = _is.read_float();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "addFoodMatterMass", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			FoodStoreOperations _localServant = (FoodStoreOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.addFoodMatterMass(pMatter);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void setInitialFoodMatterLevel(com.traclabs.biosim.idl.simulation.food.FoodMatter pFoodMatter)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setInitialFoodMatterLevel", true);
				com.traclabs.biosim.idl.simulation.food.FoodMatterHelper.write(_os,pFoodMatter);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setInitialFoodMatterLevel", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			FoodStoreOperations _localServant = (FoodStoreOperations)_so.servant;
			try
			{
			_localServant.setInitialFoodMatterLevel(pFoodMatter);
			}
			finally
			{
				_servant_postinvoke(_so);
