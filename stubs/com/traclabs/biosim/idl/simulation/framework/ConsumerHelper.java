...
public final class ConsumerHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0", "Consumer");
	}
	...
	public static com.traclabs.biosim.idl.simulation.framework.Consumer narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.simulation.framework.Consumer)
		{
	...
	public static com.traclabs.biosim.idl.simulation.framework.Consumer narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0"))
			{
