...
public class StoreFlowRateControllablePOATie
	extends StoreFlowRateControllablePOA
{
	private StoreFlowRateControllableOperations _delegate;

	private POA _poa;
	public StoreFlowRateControllablePOATie(StoreFlowRateControllableOperations delegate)
	{
		_delegate = delegate;
	}
	public StoreFlowRateControllablePOATie(StoreFlowRateControllableOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public StoreFlowRateControllableOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(StoreFlowRateControllableOperations delegate)
	{
		_delegate = delegate;
	}
