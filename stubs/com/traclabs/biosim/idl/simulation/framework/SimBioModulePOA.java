...
public abstract class SimBioModulePOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.framework.SimBioModuleOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/framework/SimBioModule:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.simulation.framework.SimBioModule _this()
	{
		return com.traclabs.biosim.idl.simulation.framework.SimBioModuleHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.framework.SimBioModule _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.framework.SimBioModuleHelper.narrow(_this_object(orb));
	}
