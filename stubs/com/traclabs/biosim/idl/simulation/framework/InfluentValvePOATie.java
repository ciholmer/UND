...
public class InfluentValvePOATie
	extends InfluentValvePOA
{
	private InfluentValveOperations _delegate;

	private POA _poa;
	public InfluentValvePOATie(InfluentValveOperations delegate)
	{
		_delegate = delegate;
	}
	public InfluentValvePOATie(InfluentValveOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public InfluentValveOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(InfluentValveOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.fixMalfunction(id);
	...
	{
		return _delegate.getIndexOfInfluentStore();
	}
...
_delegate.clearAllMalfunctions();
	...
	{
_delegate.setIndexOfInfluentStore(pIndexOfEffluentStore);
	}
