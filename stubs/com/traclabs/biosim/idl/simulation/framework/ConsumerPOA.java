...
public abstract class ConsumerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.framework.ConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "fixAllMalfunctions", new java.lang.Integer(21));
		m_opsHash.put ( "getMalfunctions", new java.lang.Integer(22));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.simulation.framework.Consumer _this()
	{
		return com.traclabs.biosim.idl.simulation.framework.ConsumerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.framework.Consumer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.framework.ConsumerHelper.narrow(_this_object(orb));
	}
