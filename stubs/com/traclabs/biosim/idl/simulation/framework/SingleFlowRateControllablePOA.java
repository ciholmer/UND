...
public abstract class SingleFlowRateControllablePOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.framework.SingleFlowRateControllableOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "setInitialActualFlowRates", new java.lang.Integer(0));
		m_opsHash.put ( "getMaxFlowRate", new java.lang.Integer(1));
		m_opsHash.put ( "getDesiredFlowRates", new java.lang.Integer(2));
		m_opsHash.put ( "getActualFlowRates", new java.lang.Integer(3));
		m_opsHash.put ( "setDesiredFlowRate", new java.lang.Integer(4));
		m_opsHash.put ( "getTotalDesiredFlowRate", new java.lang.Integer(5));
		m_opsHash.put ( "getMaxFlowRates", new java.lang.Integer(6));
		m_opsHash.put ( "getTotalMaxFlowRate", new java.lang.Integer(7));
		m_opsHash.put ( "getActualFlowRate", new java.lang.Integer(8));
		m_opsHash.put ( "getTotalActualFlowRate", new java.lang.Integer(9));
		m_opsHash.put ( "setMaxFlowRate", new java.lang.Integer(10));
		m_opsHash.put ( "setInitialDesiredFlowRates", new java.lang.Integer(11));
		m_opsHash.put ( "setInitialMaxFlowRates", new java.lang.Integer(12));
		m_opsHash.put ( "getAveragePercentageFull", new java.lang.Integer(13));
		m_opsHash.put ( "getPercentageFull", new java.lang.Integer(14));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		{
			case 0: // setInitialActualFlowRates
			{
			...
			case 5: // getTotalDesiredFlowRate
			{
				_out = handler.createReply();
			...
			case 11: // setInitialDesiredFlowRates
			{
				float[] _arg0=com.traclabs.biosim.idl.FloatListHelper.read(_input);
				_out = handler.createReply();
			...
			case 13: // getAveragePercentageFull
			{
				_out = handler.createReply();
				_out.write_float(getAveragePercentageFull());
				break;
			}
			case 14: // getPercentageFull
			{
				int _arg0=_input.read_long();
				_out = handler.createReply();
