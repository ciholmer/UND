...
public abstract class StoreFlowRateControllablePOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllableOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getTotalMaxFlowRate", new java.lang.Integer(15));
		m_opsHash.put ( "connectsTo", new java.lang.Integer(16));
		m_opsHash.put ( "getDesiredFlowRates", new java.lang.Integer(17));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllable _this()
	{
		return com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllableHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllable _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllableHelper.narrow(_this_object(orb));
	}
