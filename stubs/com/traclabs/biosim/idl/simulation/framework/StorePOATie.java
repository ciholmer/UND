...
public class StorePOATie
	extends StorePOA
{
	private StoreOperations _delegate;

	private POA _poa;
	public StorePOATie(StoreOperations delegate)
	{
		_delegate = delegate;
	}
	public StorePOATie(StoreOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public StoreOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(StoreOperations delegate)
	{
		_delegate = delegate;
	}
