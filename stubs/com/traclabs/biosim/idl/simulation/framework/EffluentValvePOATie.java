...
public class EffluentValvePOATie
	extends EffluentValvePOA
{
	private EffluentValveOperations _delegate;

	private POA _poa;
	public EffluentValvePOATie(EffluentValveOperations delegate)
	{
		_delegate = delegate;
	}
	public EffluentValvePOATie(EffluentValveOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public EffluentValveOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(EffluentValveOperations delegate)
	{
		_delegate = delegate;
	}
	...
	{
		return _delegate.getIndexOfEffluentStore();
	}
