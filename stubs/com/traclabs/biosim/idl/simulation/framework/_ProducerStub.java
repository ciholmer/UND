...
public class _ProducerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.framework.Producer
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.framework.ProducerOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			ProducerOperations _localServant = (ProducerOperations)_so.servant;
			float _result;			try
			{
