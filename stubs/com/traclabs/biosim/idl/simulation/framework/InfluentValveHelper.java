...
public final class InfluentValveHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/framework/InfluentValve:1.0", "InfluentValve");
	}
	...
	public static com.traclabs.biosim.idl.simulation.framework.InfluentValve narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.simulation.framework.InfluentValve)
		{
	...
	public static com.traclabs.biosim.idl.simulation.framework.InfluentValve narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/framework/InfluentValve:1.0"))
			{
