...
public class SimBioModulePOATie
	extends SimBioModulePOA
{
	private SimBioModuleOperations _delegate;

	private POA _poa;
	public SimBioModulePOATie(SimBioModuleOperations delegate)
	{
		_delegate = delegate;
	}
	public SimBioModulePOATie(SimBioModuleOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public SimBioModuleOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(SimBioModuleOperations delegate)
	{
		_delegate = delegate;
	}
