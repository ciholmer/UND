...
public final class ProducerHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0", "Producer");
	}
	...
	public static com.traclabs.biosim.idl.simulation.framework.Producer narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.simulation.framework.Producer)
		{
	...
	public static com.traclabs.biosim.idl.simulation.framework.Producer narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0"))
			{
