...
public final class StoreFlowRateControllableHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0", "StoreFlowRateControllable");
	}
	...
	public static com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllable narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllable)
		{
	...
	public static com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllable narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0"))
			{
