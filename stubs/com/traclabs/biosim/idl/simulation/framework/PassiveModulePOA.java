...
public abstract class PassiveModulePOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.framework.PassiveModuleOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "fixAllMalfunctions", new java.lang.Integer(24));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/framework/PassiveModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SimBioModule:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.simulation.framework.PassiveModule _this()
	{
		return com.traclabs.biosim.idl.simulation.framework.PassiveModuleHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.framework.PassiveModule _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.framework.PassiveModuleHelper.narrow(_this_object(orb));
	}
