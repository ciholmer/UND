...
public class _StoreFlowRateControllableStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllable
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllableOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			StoreFlowRateControllableOperations _localServant = (StoreFlowRateControllableOperations)_so.servant;
			float _result;			try
			{
