...
public final class MethaneStoreHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/air/MethaneStore:1.0", "MethaneStore");
	}
	...
	public static com.traclabs.biosim.idl.simulation.air.MethaneStore narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.simulation.air.MethaneStore)
		{
	...
	public static com.traclabs.biosim.idl.simulation.air.MethaneStore narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/air/MethaneStore:1.0"))
			{
