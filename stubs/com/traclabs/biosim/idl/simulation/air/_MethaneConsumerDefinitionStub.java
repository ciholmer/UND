...
public class _MethaneConsumerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.air.MethaneConsumerDefinition
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/MethaneConsumerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.air.MethaneConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			MethaneConsumerDefinitionOperations _localServant = (MethaneConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setMethaneInputs(com.traclabs.biosim.idl.simulation.air.MethaneStore[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setMethaneInputs", true);
				com.traclabs.biosim.idl.simulation.air.MethaneStoreListHelper.write(_os,sources);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setMethaneInputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			MethaneConsumerDefinitionOperations _localServant = (MethaneConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setMethaneInputs(sources,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
