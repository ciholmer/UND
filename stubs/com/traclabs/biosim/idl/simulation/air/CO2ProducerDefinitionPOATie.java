...
public class CO2ProducerDefinitionPOATie
	extends CO2ProducerDefinitionPOA
{
	private CO2ProducerDefinitionOperations _delegate;

	private POA _poa;
	public CO2ProducerDefinitionPOATie(CO2ProducerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
	public CO2ProducerDefinitionPOATie(CO2ProducerDefinitionOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public CO2ProducerDefinitionOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(CO2ProducerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.setInitialDesiredFlowRates(flowrates);
	...
	{
_delegate.setCO2Outputs(destinations,maxFlowRates,desiredFlowRates);
	}
