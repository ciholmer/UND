...
public abstract class NitrogenProducerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.NitrogenProducerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setNitrogenOutputs", new java.lang.Integer(6));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 6: // setNitrogenOutputs
			{
				...
				_out = handler.createReply();
				setNitrogenOutputs(_arg0,_arg1,_arg2);
				break;
			}
			case 7: // reset
			{
