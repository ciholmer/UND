...
public abstract class MethaneProducerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.MethaneProducerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setMethaneOutputs", new java.lang.Integer(8));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 8: // setMethaneOutputs
			{
				com.traclabs.biosim.idl.simulation.air.MethaneStore[] _arg0=com.traclabs.biosim.idl.simulation.air.MethaneStoreListHelper.read(_input);
				...
				_out = handler.createReply();
				setMethaneOutputs(_arg0,_arg1,_arg2);
				break;
			}
