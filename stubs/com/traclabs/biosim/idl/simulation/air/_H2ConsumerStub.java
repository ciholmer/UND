...
public class _H2ConsumerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.air.H2Consumer
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/H2Consumer:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.air.H2ConsumerOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			H2ConsumerOperations _localServant = (H2ConsumerOperations)_so.servant;
			float _result;			try
			{
