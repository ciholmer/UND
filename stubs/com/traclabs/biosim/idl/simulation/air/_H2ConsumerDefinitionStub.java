...
public class _H2ConsumerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.air.H2ConsumerDefinition
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/H2ConsumerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.air.H2ConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			H2ConsumerDefinitionOperations _localServant = (H2ConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setH2Inputs(com.traclabs.biosim.idl.simulation.air.H2Store[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setH2Inputs", true);
				com.traclabs.biosim.idl.simulation.air.H2StoreListHelper.write(_os,sources);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setH2Inputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			H2ConsumerDefinitionOperations _localServant = (H2ConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setH2Inputs(sources,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
