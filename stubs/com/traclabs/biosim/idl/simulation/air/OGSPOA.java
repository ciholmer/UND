...
public abstract class OGSPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.OGSOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getO2ProducerDefinition", new java.lang.Integer(5));
		...
		m_opsHash.put ( "getH2ProducerDefinition", new java.lang.Integer(16));
		...
		m_opsHash.put ( "getPotableWaterConsumerDefinition", new java.lang.Integer(25));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 5: // getO2ProducerDefinition
			{
				_out = handler.createReply();
			...
			case 16: // getH2ProducerDefinition
			{
				_out = handler.createReply();
			...
			case 25: // getPotableWaterConsumerDefinition
			{
				_out = handler.createReply();
