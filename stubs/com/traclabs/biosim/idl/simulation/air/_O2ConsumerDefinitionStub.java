...
public class _O2ConsumerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.air.O2ConsumerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.air.O2ConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			O2ConsumerDefinitionOperations _localServant = (O2ConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setO2Inputs(com.traclabs.biosim.idl.simulation.air.O2Store[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setO2Inputs", true);
				com.traclabs.biosim.idl.simulation.air.O2StoreListHelper.write(_os,sources);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setO2Inputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			O2ConsumerDefinitionOperations _localServant = (O2ConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setO2Inputs(sources,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
