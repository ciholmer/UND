...
public class _CO2ConsumerDefinitionStub
	...
	implements com.traclabs.biosim.idl.simulation.air.CO2ConsumerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.air.CO2ConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			CO2ConsumerDefinitionOperations _localServant = (CO2ConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setCO2Inputs(com.traclabs.biosim.idl.simulation.air.CO2Store[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setCO2Inputs", true);
				com.traclabs.biosim.idl.simulation.air.CO2StoreListHelper.write(_os,sources);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setCO2Inputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			CO2ConsumerDefinitionOperations _localServant = (CO2ConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setCO2Inputs(sources,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
