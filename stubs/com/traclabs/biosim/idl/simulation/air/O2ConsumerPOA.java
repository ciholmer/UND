...
public abstract class O2ConsumerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.O2ConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getO2ConsumerDefinition", new java.lang.Integer(19));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/O2Consumer:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.simulation.air.O2Consumer _this()
	{
		return com.traclabs.biosim.idl.simulation.air.O2ConsumerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.air.O2Consumer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.air.O2ConsumerHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 19: // getO2ConsumerDefinition
			{
				_out = handler.createReply();
