...
public class CO2ProducerPOATie
	extends CO2ProducerPOA
{
	private CO2ProducerOperations _delegate;

	private POA _poa;
	public CO2ProducerPOATie(CO2ProducerOperations delegate)
	{
		_delegate = delegate;
	}
	public CO2ProducerPOATie(CO2ProducerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public com.traclabs.biosim.idl.simulation.air.CO2Producer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.air.CO2ProducerHelper.narrow(_this_object(orb));
	}
	public CO2ProducerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(CO2ProducerOperations delegate)
	{
		_delegate = delegate;
	}
