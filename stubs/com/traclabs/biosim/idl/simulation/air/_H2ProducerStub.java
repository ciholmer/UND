...
public class _H2ProducerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.air.H2Producer
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/H2Producer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.air.H2ProducerOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			H2ProducerOperations _localServant = (H2ProducerOperations)_so.servant;
			float _result;			try
			{
