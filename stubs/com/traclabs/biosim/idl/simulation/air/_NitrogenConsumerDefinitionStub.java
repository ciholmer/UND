...
public class _NitrogenConsumerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.air.NitrogenConsumerDefinition
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/NitrogenConsumerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.air.NitrogenConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			NitrogenConsumerDefinitionOperations _localServant = (NitrogenConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setNitrogenInputs(com.traclabs.biosim.idl.simulation.air.NitrogenStore[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setNitrogenInputs", true);
				com.traclabs.biosim.idl.simulation.air.NitrogenStoreListHelper.write(_os,sources);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setNitrogenInputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			NitrogenConsumerDefinitionOperations _localServant = (NitrogenConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setNitrogenInputs(sources,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
