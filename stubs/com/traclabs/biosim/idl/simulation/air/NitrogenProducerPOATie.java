...
public class NitrogenProducerPOATie
	extends NitrogenProducerPOA
{
	private NitrogenProducerOperations _delegate;

	private POA _poa;
	public NitrogenProducerPOATie(NitrogenProducerOperations delegate)
	{
		_delegate = delegate;
	}
	public NitrogenProducerPOATie(NitrogenProducerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public NitrogenProducerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(NitrogenProducerOperations delegate)
	{
		_delegate = delegate;
	}
