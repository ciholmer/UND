...
public class MethaneProducerPOATie
	extends MethaneProducerPOA
{
	private MethaneProducerOperations _delegate;

	private POA _poa;
	public MethaneProducerPOATie(MethaneProducerOperations delegate)
	{
		_delegate = delegate;
	}
	public MethaneProducerPOATie(MethaneProducerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	{
		return com.traclabs.biosim.idl.simulation.air.MethaneProducerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.air.MethaneProducer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.air.MethaneProducerHelper.narrow(_this_object(orb));
	}
	public MethaneProducerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(MethaneProducerOperations delegate)
	{
		_delegate = delegate;
	}
