...
public class H2StorePOATie
	extends H2StorePOA
{
	private H2StoreOperations _delegate;

	private POA _poa;
	public H2StorePOATie(H2StoreOperations delegate)
	{
		_delegate = delegate;
	}
	public H2StorePOATie(H2StoreOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public H2StoreOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(H2StoreOperations delegate)
	{
		_delegate = delegate;
	}
