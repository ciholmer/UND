...
public abstract class CO2ProducerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.CO2ProducerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setCO2Outputs", new java.lang.Integer(8));
	...
	public com.traclabs.biosim.idl.simulation.air.CO2ProducerDefinition _this()
	{
		return com.traclabs.biosim.idl.simulation.air.CO2ProducerDefinitionHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.air.CO2ProducerDefinition _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.air.CO2ProducerDefinitionHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 8: // setCO2Outputs
			{
				com.traclabs.biosim.idl.simulation.air.CO2Store[] _arg0=com.traclabs.biosim.idl.simulation.air.CO2StoreListHelper.read(_input);
				...
				_out = handler.createReply();
				setCO2Outputs(_arg0,_arg1,_arg2);
				break;
			}
