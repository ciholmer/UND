...
public class O2ConsumerPOATie
	extends O2ConsumerPOA
{
	private O2ConsumerOperations _delegate;

	private POA _poa;
	public O2ConsumerPOATie(O2ConsumerOperations delegate)
	{
		_delegate = delegate;
	}
	public O2ConsumerPOATie(O2ConsumerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public O2ConsumerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(O2ConsumerOperations delegate)
	{
		_delegate = delegate;
	}
