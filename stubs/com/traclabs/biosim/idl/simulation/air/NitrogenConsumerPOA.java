...
public abstract class NitrogenConsumerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.NitrogenConsumerOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "getTickLength", new java.lang.Integer(0));
		m_opsHash.put ( "getNitrogenConsumerDefinition", new java.lang.Integer(1));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/NitrogenConsumer:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.simulation.air.NitrogenConsumer _this()
	{
		return com.traclabs.biosim.idl.simulation.air.NitrogenConsumerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.air.NitrogenConsumer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.air.NitrogenConsumerHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 1: // getNitrogenConsumerDefinition
			{
				_out = handler.createReply();
