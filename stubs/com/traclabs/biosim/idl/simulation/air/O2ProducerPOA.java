...
public abstract class O2ProducerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.O2ProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getO2ProducerDefinition", new java.lang.Integer(3));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/O2Producer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0"};
	public com.traclabs.biosim.idl.simulation.air.O2Producer _this()
	{
		return com.traclabs.biosim.idl.simulation.air.O2ProducerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.air.O2Producer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.air.O2ProducerHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 3: // getO2ProducerDefinition
			{
				_out = handler.createReply();
