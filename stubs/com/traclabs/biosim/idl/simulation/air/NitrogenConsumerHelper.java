...
public final class NitrogenConsumerHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/air/NitrogenConsumer:1.0", "NitrogenConsumer");
	}
	...
	public static com.traclabs.biosim.idl.simulation.air.NitrogenConsumer narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.simulation.air.NitrogenConsumer)
		{
	...
	public static com.traclabs.biosim.idl.simulation.air.NitrogenConsumer narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/air/NitrogenConsumer:1.0"))
			{
