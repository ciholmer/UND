...
public class NitrogenConsumerPOATie
	extends NitrogenConsumerPOA
{
	private NitrogenConsumerOperations _delegate;

	private POA _poa;
	public NitrogenConsumerPOATie(NitrogenConsumerOperations delegate)
	{
		_delegate = delegate;
	}
	public NitrogenConsumerPOATie(NitrogenConsumerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public NitrogenConsumerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(NitrogenConsumerOperations delegate)
	{
		_delegate = delegate;
	}
