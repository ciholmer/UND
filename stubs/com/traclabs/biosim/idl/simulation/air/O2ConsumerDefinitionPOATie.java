...
public class O2ConsumerDefinitionPOATie
	extends O2ConsumerDefinitionPOA
{
	private O2ConsumerDefinitionOperations _delegate;

	private POA _poa;
	public O2ConsumerDefinitionPOATie(O2ConsumerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
	public O2ConsumerDefinitionPOATie(O2ConsumerDefinitionOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	{
		return com.traclabs.biosim.idl.simulation.air.O2ConsumerDefinitionHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.air.O2ConsumerDefinition _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.air.O2ConsumerDefinitionHelper.narrow(_this_object(orb));
	}
	public O2ConsumerDefinitionOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(O2ConsumerDefinitionOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.setInitialStores(pStores);
	...
	public void setO2Inputs(com.traclabs.biosim.idl.simulation.air.O2Store[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
_delegate.setO2Inputs(sources,maxFlowRates,desiredFlowRates);
	}
