...
public class O2ProducerPOATie
	extends O2ProducerPOA
{
	private O2ProducerOperations _delegate;

	private POA _poa;
	public O2ProducerPOATie(O2ProducerOperations delegate)
	{
		_delegate = delegate;
	}
	public O2ProducerPOATie(O2ProducerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public O2ProducerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(O2ProducerOperations delegate)
	{
		_delegate = delegate;
	}
