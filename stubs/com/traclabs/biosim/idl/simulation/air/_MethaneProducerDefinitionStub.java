...
public class _MethaneProducerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.air.MethaneProducerDefinition
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/MethaneProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.air.MethaneProducerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			MethaneProducerDefinitionOperations _localServant = (MethaneProducerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setMethaneOutputs(com.traclabs.biosim.idl.simulation.air.MethaneStore[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setMethaneOutputs", true);
				com.traclabs.biosim.idl.simulation.air.MethaneStoreListHelper.write(_os,destinations);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setMethaneOutputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			MethaneProducerDefinitionOperations _localServant = (MethaneProducerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setMethaneOutputs(destinations,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
