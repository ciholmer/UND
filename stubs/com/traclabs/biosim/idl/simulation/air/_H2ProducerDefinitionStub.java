...
public class _H2ProducerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.air.H2ProducerDefinition
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/H2ProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.air.H2ProducerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			H2ProducerDefinitionOperations _localServant = (H2ProducerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setH2Outputs(com.traclabs.biosim.idl.simulation.air.H2Store[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setH2Outputs", true);
				com.traclabs.biosim.idl.simulation.air.H2StoreListHelper.write(_os,destinations);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setH2Outputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			H2ProducerDefinitionOperations _localServant = (H2ProducerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setH2Outputs(destinations,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
