...
public abstract class NitrogenProducerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.NitrogenProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getNitrogenProducerDefinition", new java.lang.Integer(10));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/NitrogenProducer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0"};
	public com.traclabs.biosim.idl.simulation.air.NitrogenProducer _this()
	{
		return com.traclabs.biosim.idl.simulation.air.NitrogenProducerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.air.NitrogenProducer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.air.NitrogenProducerHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 10: // getNitrogenProducerDefinition
			{
				_out = handler.createReply();
