...
public class VCCRPOATie
	extends VCCRPOA
{
	private VCCROperations _delegate;

	private POA _poa;
	public VCCRPOATie(VCCROperations delegate)
	{
		_delegate = delegate;
	}
	public VCCRPOATie(VCCROperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public VCCROperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(VCCROperations delegate)
	{
		_delegate = delegate;
	}
