...
public class _O2ProducerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.air.O2ProducerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.air.O2ProducerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			O2ProducerDefinitionOperations _localServant = (O2ProducerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setO2Outputs(com.traclabs.biosim.idl.simulation.air.O2Store[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setO2Outputs", true);
				com.traclabs.biosim.idl.simulation.air.O2StoreListHelper.write(_os,destinations);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setO2Outputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			O2ProducerDefinitionOperations _localServant = (O2ProducerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setO2Outputs(destinations,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
