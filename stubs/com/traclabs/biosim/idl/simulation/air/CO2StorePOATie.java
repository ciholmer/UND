...
public class CO2StorePOATie
	extends CO2StorePOA
{
	private CO2StoreOperations _delegate;

	private POA _poa;
	public CO2StorePOATie(CO2StoreOperations delegate)
	{
		_delegate = delegate;
	}
	public CO2StorePOATie(CO2StoreOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public CO2StoreOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(CO2StoreOperations delegate)
	{
		_delegate = delegate;
	}
