...
public abstract class H2ProducerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.H2ProducerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setH2Outputs", new java.lang.Integer(18));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 18: // setH2Outputs
			{
				com.traclabs.biosim.idl.simulation.air.H2Store[] _arg0=com.traclabs.biosim.idl.simulation.air.H2StoreListHelper.read(_input);
				...
				_out = handler.createReply();
				setH2Outputs(_arg0,_arg1,_arg2);
				break;
			}
