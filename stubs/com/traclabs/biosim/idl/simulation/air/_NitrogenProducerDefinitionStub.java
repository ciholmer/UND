...
public class _NitrogenProducerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.air.NitrogenProducerDefinition
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/NitrogenProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.air.NitrogenProducerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			NitrogenProducerDefinitionOperations _localServant = (NitrogenProducerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setNitrogenOutputs(com.traclabs.biosim.idl.simulation.air.NitrogenStore[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setNitrogenOutputs", true);
				com.traclabs.biosim.idl.simulation.air.NitrogenStoreListHelper.write(_os,destinations);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setNitrogenOutputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			NitrogenProducerDefinitionOperations _localServant = (NitrogenProducerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setNitrogenOutputs(destinations,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
