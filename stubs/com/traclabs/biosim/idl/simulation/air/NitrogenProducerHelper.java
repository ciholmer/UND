...
public final class NitrogenProducerHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/air/NitrogenProducer:1.0", "NitrogenProducer");
	}
	...
	public static com.traclabs.biosim.idl.simulation.air.NitrogenProducer narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.simulation.air.NitrogenProducer)
		{
	...
	public static com.traclabs.biosim.idl.simulation.air.NitrogenProducer narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/air/NitrogenProducer:1.0"))
			{
