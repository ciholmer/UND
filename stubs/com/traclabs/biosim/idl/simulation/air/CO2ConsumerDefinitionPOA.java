...
public abstract class CO2ConsumerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.CO2ConsumerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setCO2Inputs", new java.lang.Integer(7));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 7: // setCO2Inputs
			{
				...
				_out = handler.createReply();
				setCO2Inputs(_arg0,_arg1,_arg2);
				break;
			}
