...
public abstract class NitrogenConsumerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.NitrogenConsumerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setNitrogenInputs", new java.lang.Integer(5));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 5: // setNitrogenInputs
			{
				com.traclabs.biosim.idl.simulation.air.NitrogenStore[] _arg0=com.traclabs.biosim.idl.simulation.air.NitrogenStoreListHelper.read(_input);
				...
				_out = handler.createReply();
				setNitrogenInputs(_arg0,_arg1,_arg2);
				break;
			}
