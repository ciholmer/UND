...
public class O2StorePOATie
	extends O2StorePOA
{
	private O2StoreOperations _delegate;

	private POA _poa;
	public O2StorePOATie(O2StoreOperations delegate)
	{
		_delegate = delegate;
	}
	public O2StorePOATie(O2StoreOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public com.traclabs.biosim.idl.simulation.air.O2Store _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.air.O2StoreHelper.narrow(_this_object(orb));
	}
	public O2StoreOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(O2StoreOperations delegate)
	{
		_delegate = delegate;
	}
