...
public class H2ConsumerPOATie
	extends H2ConsumerPOA
{
	private H2ConsumerOperations _delegate;

	private POA _poa;
	public H2ConsumerPOATie(H2ConsumerOperations delegate)
	{
		_delegate = delegate;
	}
	public H2ConsumerPOATie(H2ConsumerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public H2ConsumerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(H2ConsumerOperations delegate)
	{
		_delegate = delegate;
	}
