...
public class _GenericPowerConsumerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.power.GenericPowerConsumer
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.power.GenericPowerConsumerOperations.class;
	...
	public float getPercentageOfPowerAskedDelivered()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getPercentageOfPowerAskedDelivered", true);
				_is = _invoke(_os);
				float _result = _is.read_float();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getPercentageOfPowerAskedDelivered", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			GenericPowerConsumerOperations _localServant = (GenericPowerConsumerOperations)_so.servant;
			float _result;			try
			{
			_result = _localServant.getPercentageOfPowerAskedDelivered();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void setPowerRequired(float pWatts)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setPowerRequired", true);
				_os.write_float(pWatts);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setPowerRequired", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			GenericPowerConsumerOperations _localServant = (GenericPowerConsumerOperations)_so.servant;
			try
			{
			_localServant.setPowerRequired(pWatts);
			}
			finally
			{
				_servant_postinvoke(_so);
