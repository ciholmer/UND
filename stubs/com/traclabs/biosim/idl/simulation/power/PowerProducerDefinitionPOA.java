...
public abstract class PowerProducerDefinitionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.power.PowerProducerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setPowerOutputs", new java.lang.Integer(20));
	...
	{
		return com.traclabs.biosim.idl.simulation.power.PowerProducerDefinitionHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.power.PowerProducerDefinition _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.power.PowerProducerDefinitionHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 20: // setPowerOutputs
			{
				com.traclabs.biosim.idl.simulation.power.PowerStore[] _arg0=com.traclabs.biosim.idl.simulation.power.PowerStoreListHelper.read(_input);
				...
				_out = handler.createReply();
				setPowerOutputs(_arg0,_arg1,_arg2);
				break;
			}
