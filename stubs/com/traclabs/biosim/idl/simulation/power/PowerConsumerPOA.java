...
public abstract class PowerConsumerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.power.PowerConsumerOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/power/PowerConsumer:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.simulation.power.PowerConsumer _this()
	{
		return com.traclabs.biosim.idl.simulation.power.PowerConsumerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.power.PowerConsumer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.power.PowerConsumerHelper.narrow(_this_object(orb));
	}
