...
public class _PowerConsumerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.power.PowerConsumerDefinition
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.power.PowerConsumerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			PowerConsumerDefinitionOperations _localServant = (PowerConsumerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setPowerInputs(com.traclabs.biosim.idl.simulation.power.PowerStore[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setPowerInputs", true);
				com.traclabs.biosim.idl.simulation.power.PowerStoreListHelper.write(_os,sources);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setPowerInputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			PowerConsumerDefinitionOperations _localServant = (PowerConsumerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setPowerInputs(sources,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
