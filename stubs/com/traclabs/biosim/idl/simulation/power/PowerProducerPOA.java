...
public abstract class PowerProducerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.power.PowerProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getPowerProducerDefinition", new java.lang.Integer(21));
		m_opsHash.put ( "getMalfunctions", new java.lang.Integer(22));
		m_opsHash.put ( "fixAllMalfunctions", new java.lang.Integer(23));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/power/PowerProducer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0"};
	public com.traclabs.biosim.idl.simulation.power.PowerProducer _this()
	{
		return com.traclabs.biosim.idl.simulation.power.PowerProducerHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.simulation.power.PowerProducer _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.simulation.power.PowerProducerHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 21: // getPowerProducerDefinition
			{
				_out = handler.createReply();
