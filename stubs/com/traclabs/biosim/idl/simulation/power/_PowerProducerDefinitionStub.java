...
public class _PowerProducerDefinitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.simulation.power.PowerProducerDefinition
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/power/PowerProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/StoreFlowRateControllable:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SingleFlowRateControllable:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.simulation.power.PowerProducerDefinitionOperations.class;
	public float getPercentageFull(int index)
	{
		...
		else
		{
			...
			PowerProducerDefinitionOperations _localServant = (PowerProducerDefinitionOperations)_so.servant;
			float _result;			try
			{
	...
	public void setPowerOutputs(com.traclabs.biosim.idl.simulation.power.PowerStore[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setPowerOutputs", true);
				com.traclabs.biosim.idl.simulation.power.PowerStoreListHelper.write(_os,destinations);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setPowerOutputs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			PowerProducerDefinitionOperations _localServant = (PowerProducerDefinitionOperations)_so.servant;
			try
			{
			_localServant.setPowerOutputs(destinations,maxFlowRates,desiredFlowRates);
			}
			finally
			{
				_servant_postinvoke(_so);
