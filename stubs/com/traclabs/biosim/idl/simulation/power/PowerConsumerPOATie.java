...
public class PowerConsumerPOATie
	extends PowerConsumerPOA
{
	private PowerConsumerOperations _delegate;

	private POA _poa;
	public PowerConsumerPOATie(PowerConsumerOperations delegate)
	{
		_delegate = delegate;
	}
	public PowerConsumerPOATie(PowerConsumerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public PowerConsumerOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(PowerConsumerOperations delegate)
	{
		_delegate = delegate;
	}
