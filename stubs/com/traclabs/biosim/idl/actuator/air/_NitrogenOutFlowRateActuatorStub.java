...
public class _NitrogenOutFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.air.NitrogenOutFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.air.NitrogenOutFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			NitrogenOutFlowRateActuatorOperations _localServant = (NitrogenOutFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.NitrogenProducer getOutput()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.air.NitrogenProducer _result = com.traclabs.biosim.idl.simulation.air.NitrogenProducerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			NitrogenOutFlowRateActuatorOperations _localServant = (NitrogenOutFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.NitrogenProducer _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.air.NitrogenProducer pProducer, int pIndex)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.air.NitrogenProducerHelper.write(_os,pProducer);
