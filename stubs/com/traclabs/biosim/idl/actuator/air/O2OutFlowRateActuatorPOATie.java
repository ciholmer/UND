...
public class O2OutFlowRateActuatorPOATie
	extends O2OutFlowRateActuatorPOA
{
	private O2OutFlowRateActuatorOperations _delegate;

	private POA _poa;
	public O2OutFlowRateActuatorPOATie(O2OutFlowRateActuatorOperations delegate)
	{
		_delegate = delegate;
	}
	public O2OutFlowRateActuatorPOATie(O2OutFlowRateActuatorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public O2OutFlowRateActuatorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(O2OutFlowRateActuatorOperations delegate)
	{
		_delegate = delegate;
	}
