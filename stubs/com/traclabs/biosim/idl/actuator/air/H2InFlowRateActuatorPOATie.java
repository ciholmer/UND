...
public class H2InFlowRateActuatorPOATie
	extends H2InFlowRateActuatorPOA
{
	private H2InFlowRateActuatorOperations _delegate;

	private POA _poa;
	public H2InFlowRateActuatorPOATie(H2InFlowRateActuatorOperations delegate)
	{
		_delegate = delegate;
	}
	public H2InFlowRateActuatorPOATie(H2InFlowRateActuatorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public H2InFlowRateActuatorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(H2InFlowRateActuatorOperations delegate)
	{
		_delegate = delegate;
	}
