...
public abstract class MethaneInFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.air.MethaneInFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", new java.lang.Integer(15));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/air/MethaneInFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.air.MethaneInFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.air.MethaneInFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.air.MethaneInFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.air.MethaneInFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.air.MethaneConsumerHelper.write(_out,getOutput());
				break;
			}
			...
			case 15: // setOutput
			{
				com.traclabs.biosim.idl.simulation.air.MethaneConsumer _arg0=com.traclabs.biosim.idl.simulation.air.MethaneConsumerHelper.read(_input);
