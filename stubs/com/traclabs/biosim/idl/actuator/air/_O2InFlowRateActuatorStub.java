...
public class _O2InFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.air.O2InFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.air.O2InFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			O2InFlowRateActuatorOperations _localServant = (O2InFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.air.O2Consumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.air.O2ConsumerHelper.write(_os,pConsumer);
	...
	public com.traclabs.biosim.idl.simulation.air.O2Consumer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.air.O2Consumer _result = com.traclabs.biosim.idl.simulation.air.O2ConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			O2InFlowRateActuatorOperations _localServant = (O2InFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.O2Consumer _result;			try
			{
