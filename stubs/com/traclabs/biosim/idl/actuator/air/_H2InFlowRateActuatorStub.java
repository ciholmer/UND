...
public class _H2InFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.air.H2InFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.air.H2InFlowRateActuatorOperations.class;
	public void setOutput(com.traclabs.biosim.idl.simulation.air.H2Consumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.air.H2ConsumerHelper.write(_os,pConsumer);
		...
		else
		{
			...
			H2InFlowRateActuatorOperations _localServant = (H2InFlowRateActuatorOperations)_so.servant;
			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.H2Consumer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.air.H2Consumer _result = com.traclabs.biosim.idl.simulation.air.H2ConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			H2InFlowRateActuatorOperations _localServant = (H2InFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.H2Consumer _result;			try
			{
