...
public class _AirRSActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.air.AirRSActuator
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/air/AirRSActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.air.AirRSActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			AirRSActuatorOperations _localServant = (AirRSActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.AirRS getOutput()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.air.AirRS _result = com.traclabs.biosim.idl.simulation.air.AirRSHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			AirRSActuatorOperations _localServant = (AirRSActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.AirRS _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.air.AirRS source)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.air.AirRSHelper.write(_os,source);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
