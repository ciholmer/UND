...
public class H2OutFlowRateActuatorPOATie
	extends H2OutFlowRateActuatorPOA
{
	private H2OutFlowRateActuatorOperations _delegate;

	private POA _poa;
	public H2OutFlowRateActuatorPOATie(H2OutFlowRateActuatorOperations delegate)
	{
		_delegate = delegate;
	}
	public H2OutFlowRateActuatorPOATie(H2OutFlowRateActuatorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public H2OutFlowRateActuatorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(H2OutFlowRateActuatorOperations delegate)
	{
		_delegate = delegate;
	}
