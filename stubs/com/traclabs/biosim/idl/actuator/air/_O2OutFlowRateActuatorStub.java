...
public class _O2OutFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.air.O2OutFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.air.O2OutFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			O2OutFlowRateActuatorOperations _localServant = (O2OutFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.air.O2Producer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
	...
	public com.traclabs.biosim.idl.simulation.air.O2Producer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
