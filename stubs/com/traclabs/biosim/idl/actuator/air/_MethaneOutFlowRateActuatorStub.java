...
public class _MethaneOutFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.air.MethaneOutFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.air.MethaneOutFlowRateActuatorOperations.class;
	public void setOutput(com.traclabs.biosim.idl.simulation.air.MethaneProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		...
		else
		{
			...
			MethaneOutFlowRateActuatorOperations _localServant = (MethaneOutFlowRateActuatorOperations)_so.servant;
			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.MethaneProducer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
