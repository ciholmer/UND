...
public class _MethaneInFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.air.MethaneInFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.air.MethaneInFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			MethaneInFlowRateActuatorOperations _localServant = (MethaneInFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.MethaneConsumer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.air.MethaneConsumer _result = com.traclabs.biosim.idl.simulation.air.MethaneConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			MethaneInFlowRateActuatorOperations _localServant = (MethaneInFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.MethaneConsumer _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.air.MethaneConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.air.MethaneConsumerHelper.write(_os,pConsumer);
