...
public abstract class CO2OutFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.air.CO2OutFlowRateActuatorOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/air/CO2OutFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.air.CO2OutFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.air.CO2OutFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.air.CO2OutFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.air.CO2OutFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.air.CO2ProducerHelper.write(_out,getOutput());
				break;
			}
			...
			case 15: // setOutput
			{
				com.traclabs.biosim.idl.simulation.air.CO2Producer _arg0=com.traclabs.biosim.idl.simulation.air.CO2ProducerHelper.read(_input);
