...
public abstract class NitrogenOutFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.air.NitrogenOutFlowRateActuatorOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/air/NitrogenOutFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.air.NitrogenProducerHelper.write(_out,getOutput());
				break;
			}
			...
			case 25: // setOutput
			{
				com.traclabs.biosim.idl.simulation.air.NitrogenProducer _arg0=com.traclabs.biosim.idl.simulation.air.NitrogenProducerHelper.read(_input);
