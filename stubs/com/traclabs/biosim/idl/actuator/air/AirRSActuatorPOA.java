...
public abstract class AirRSActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.air.AirRSActuatorOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.air.AirRSHelper.write(_out,getOutput());
				break;
			}
			...
			case 15: // setOutput
			{
				com.traclabs.biosim.idl.simulation.air.AirRS _arg0=com.traclabs.biosim.idl.simulation.air.AirRSHelper.read(_input);
				_out = handler.createReply();
				setOutput(_arg0);
				break;
			}
