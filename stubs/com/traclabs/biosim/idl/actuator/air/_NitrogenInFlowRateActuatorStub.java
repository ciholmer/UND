...
public class _NitrogenInFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.air.NitrogenInFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.air.NitrogenInFlowRateActuatorOperations.class;
	public void setOutput(com.traclabs.biosim.idl.simulation.air.NitrogenConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.air.NitrogenConsumerHelper.write(_os,pConsumer);
		...
		else
		{
			...
			NitrogenInFlowRateActuatorOperations _localServant = (NitrogenInFlowRateActuatorOperations)_so.servant;
			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.NitrogenConsumer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.air.NitrogenConsumer _result = com.traclabs.biosim.idl.simulation.air.NitrogenConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			NitrogenInFlowRateActuatorOperations _localServant = (NitrogenInFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.NitrogenConsumer _result;			try
			{
