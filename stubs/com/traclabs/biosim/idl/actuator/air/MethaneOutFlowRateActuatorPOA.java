...
public abstract class MethaneOutFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.air.MethaneOutFlowRateActuatorOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/air/MethaneOutFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.air.MethaneOutFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.air.MethaneOutFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.air.MethaneOutFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.air.MethaneOutFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			case 0: // setOutput
			{
				com.traclabs.biosim.idl.simulation.air.MethaneProducer _arg0=com.traclabs.biosim.idl.simulation.air.MethaneProducerHelper.read(_input);
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.air.MethaneProducerHelper.write(_out,getOutput());
				break;
			}
