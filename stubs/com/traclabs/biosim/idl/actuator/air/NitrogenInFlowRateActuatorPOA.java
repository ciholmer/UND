...
public abstract class NitrogenInFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.air.NitrogenInFlowRateActuatorOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "setOutput", new java.lang.Integer(0));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/air/NitrogenInFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.air.NitrogenInFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.air.NitrogenInFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.air.NitrogenInFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.air.NitrogenInFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			case 0: // setOutput
			{
				com.traclabs.biosim.idl.simulation.air.NitrogenConsumer _arg0=com.traclabs.biosim.idl.simulation.air.NitrogenConsumerHelper.read(_input);
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.air.NitrogenConsumerHelper.write(_out,getOutput());
				break;
			}
