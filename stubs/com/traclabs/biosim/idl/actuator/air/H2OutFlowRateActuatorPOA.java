...
public abstract class H2OutFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.air.H2OutFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", new java.lang.Integer(25));
	...
	public com.traclabs.biosim.idl.actuator.air.H2OutFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.air.H2OutFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.air.H2OutFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.air.H2OutFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.air.H2ProducerHelper.write(_out,getOutput());
				break;
			}
			...
			case 25: // setOutput
			{
				com.traclabs.biosim.idl.simulation.air.H2Producer _arg0=com.traclabs.biosim.idl.simulation.air.H2ProducerHelper.read(_input);
