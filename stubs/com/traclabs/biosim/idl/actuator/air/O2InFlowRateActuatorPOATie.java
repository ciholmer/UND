...
public class O2InFlowRateActuatorPOATie
	extends O2InFlowRateActuatorPOA
{
	private O2InFlowRateActuatorOperations _delegate;

	private POA _poa;
	public O2InFlowRateActuatorPOATie(O2InFlowRateActuatorOperations delegate)
	{
		_delegate = delegate;
	}
	public O2InFlowRateActuatorPOATie(O2InFlowRateActuatorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public O2InFlowRateActuatorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(O2InFlowRateActuatorOperations delegate)
	{
		_delegate = delegate;
	}
