...
public class _CO2InFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.air.CO2InFlowRateActuator
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/air/CO2InFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.air.CO2InFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			CO2InFlowRateActuatorOperations _localServant = (CO2InFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.CO2Consumer getOutput()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.air.CO2Consumer _result = com.traclabs.biosim.idl.simulation.air.CO2ConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			CO2InFlowRateActuatorOperations _localServant = (CO2InFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.CO2Consumer _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.air.CO2Consumer pConsumer, int pIndex)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.air.CO2ConsumerHelper.write(_os,pConsumer);
