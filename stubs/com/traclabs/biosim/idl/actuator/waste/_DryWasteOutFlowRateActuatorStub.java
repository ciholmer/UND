...
public class _DryWasteOutFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.waste.DryWasteOutFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.waste.DryWasteOutFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			DryWasteOutFlowRateActuatorOperations _localServant = (DryWasteOutFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.waste.DryWasteProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
	...
	public com.traclabs.biosim.idl.simulation.waste.DryWasteProducer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
