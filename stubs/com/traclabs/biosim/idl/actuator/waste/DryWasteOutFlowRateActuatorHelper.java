...
public final class DryWasteOutFlowRateActuatorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/waste/DryWasteOutFlowRateActuator:1.0", "DryWasteOutFlowRateActuator");
	}
	...
	public static com.traclabs.biosim.idl.actuator.waste.DryWasteOutFlowRateActuator narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.actuator.waste.DryWasteOutFlowRateActuator)
		{
	...
	public static com.traclabs.biosim.idl.actuator.waste.DryWasteOutFlowRateActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/waste/DryWasteOutFlowRateActuator:1.0"))
			{
