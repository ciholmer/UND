...
public final class AirOutFlowRateActuatorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/environment/AirOutFlowRateActuator:1.0", "AirOutFlowRateActuator");
	}
	...
	public static com.traclabs.biosim.idl.actuator.environment.AirOutFlowRateActuator narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.actuator.environment.AirOutFlowRateActuator)
		{
	...
	public static com.traclabs.biosim.idl.actuator.environment.AirOutFlowRateActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/environment/AirOutFlowRateActuator:1.0"))
			{
