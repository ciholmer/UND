...
public class AirInFlowRateActuatorPOATie
	extends AirInFlowRateActuatorPOA
{
	private AirInFlowRateActuatorOperations _delegate;

	private POA _poa;
	public AirInFlowRateActuatorPOATie(AirInFlowRateActuatorOperations delegate)
	{
		_delegate = delegate;
	}
	public AirInFlowRateActuatorPOATie(AirInFlowRateActuatorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public AirInFlowRateActuatorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(AirInFlowRateActuatorOperations delegate)
	{
		_delegate = delegate;
	}
