...
public class EnvironmentActuatorPOATie
	extends EnvironmentActuatorPOA
{
	private EnvironmentActuatorOperations _delegate;

	private POA _poa;
	public EnvironmentActuatorPOATie(EnvironmentActuatorOperations delegate)
	{
		_delegate = delegate;
	}
	public EnvironmentActuatorPOATie(EnvironmentActuatorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	{
		return com.traclabs.biosim.idl.actuator.environment.EnvironmentActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.environment.EnvironmentActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.environment.EnvironmentActuatorHelper.narrow(_this_object(orb));
	}
	public EnvironmentActuatorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(EnvironmentActuatorOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.clearAllMalfunctions();
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.environment.SimEnvironment source)
	{
...
_delegate.maintain();
	...
	public com.traclabs.biosim.idl.simulation.environment.SimEnvironment getOutput()
	{
