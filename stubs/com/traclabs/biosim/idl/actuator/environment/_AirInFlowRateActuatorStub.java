...
public class _AirInFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.environment.AirInFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.environment.AirInFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			AirInFlowRateActuatorOperations _localServant = (AirInFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.environment.AirConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.environment.AirConsumerHelper.write(_os,pConsumer);
	...
	public com.traclabs.biosim.idl.simulation.environment.AirConsumer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.environment.AirConsumer _result = com.traclabs.biosim.idl.simulation.environment.AirConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			AirInFlowRateActuatorOperations _localServant = (AirInFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.environment.AirConsumer _result;			try
			{
