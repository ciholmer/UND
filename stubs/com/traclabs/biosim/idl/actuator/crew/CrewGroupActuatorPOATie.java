...
public class CrewGroupActuatorPOATie
	extends CrewGroupActuatorPOA
{
	private CrewGroupActuatorOperations _delegate;

	private POA _poa;
	public CrewGroupActuatorPOATie(CrewGroupActuatorOperations delegate)
	{
		_delegate = delegate;
	}
	public CrewGroupActuatorPOATie(CrewGroupActuatorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public CrewGroupActuatorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(CrewGroupActuatorOperations delegate)
	{
		_delegate = delegate;
	}
