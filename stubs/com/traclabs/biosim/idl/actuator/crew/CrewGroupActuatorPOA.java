...
public abstract class CrewGroupActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.crew.CrewGroupActuatorOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/crew/CrewGroupActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.crew.CrewGroupActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.crew.CrewGroupActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.crew.CrewGroupActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.crew.CrewGroupActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.crew.CrewGroupHelper.write(_out,getOutput());
				break;
			}
