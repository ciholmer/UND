...
public class _PowerInFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.power.PowerInFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.power.PowerInFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			PowerInFlowRateActuatorOperations _localServant = (PowerInFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.power.PowerConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.power.PowerConsumerHelper.write(_os,pConsumer);
	...
	public com.traclabs.biosim.idl.simulation.power.PowerConsumer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.power.PowerConsumer _result = com.traclabs.biosim.idl.simulation.power.PowerConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			PowerInFlowRateActuatorOperations _localServant = (PowerInFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.power.PowerConsumer _result;			try
			{
