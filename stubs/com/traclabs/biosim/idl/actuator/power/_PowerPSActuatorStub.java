...
public class _PowerPSActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.power.PowerPSActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.power.PowerPSActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			PowerPSActuatorOperations _localServant = (PowerPSActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.power.PowerPS getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.power.PowerPS _result = com.traclabs.biosim.idl.simulation.power.PowerPSHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			PowerPSActuatorOperations _localServant = (PowerPSActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.power.PowerPS _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.power.PowerPS source)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.power.PowerPSHelper.write(_os,source);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
