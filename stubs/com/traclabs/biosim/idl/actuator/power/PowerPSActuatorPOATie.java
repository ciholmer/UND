...
public class PowerPSActuatorPOATie
	extends PowerPSActuatorPOA
{
	private PowerPSActuatorOperations _delegate;

	private POA _poa;
	public PowerPSActuatorPOATie(PowerPSActuatorOperations delegate)
	{
		_delegate = delegate;
	}
	public PowerPSActuatorPOATie(PowerPSActuatorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public PowerPSActuatorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(PowerPSActuatorOperations delegate)
	{
		_delegate = delegate;
	}
