...
public abstract class PowerInFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.power.PowerInFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", new java.lang.Integer(11));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/power/PowerInFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.power.PowerInFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.power.PowerInFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.power.PowerInFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.power.PowerInFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 11: // setOutput
			{
				com.traclabs.biosim.idl.simulation.power.PowerConsumer _arg0=com.traclabs.biosim.idl.simulation.power.PowerConsumerHelper.read(_input);
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.power.PowerConsumerHelper.write(_out,getOutput());
				break;
			}
