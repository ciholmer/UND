...
public class _PowerOutFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.power.PowerOutFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.power.PowerOutFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			PowerOutFlowRateActuatorOperations _localServant = (PowerOutFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.power.PowerProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
	...
	public com.traclabs.biosim.idl.simulation.power.PowerProducer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
