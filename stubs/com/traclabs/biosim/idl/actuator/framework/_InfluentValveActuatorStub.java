...
public class _InfluentValveActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.framework.InfluentValveActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.framework.InfluentValveActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			InfluentValveActuatorOperations _localServant = (InfluentValveActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.framework.InfluentValve getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.framework.InfluentValve _result = com.traclabs.biosim.idl.simulation.framework.InfluentValveHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			InfluentValveActuatorOperations _localServant = (InfluentValveActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.framework.InfluentValve _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.framework.InfluentValve pInfluentValve)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.framework.InfluentValveHelper.write(_os,pInfluentValve);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		else
		{
			...
			try
			{
			_localServant.setOutput(pInfluentValve);
			}
			finally
			{
				_servant_postinvoke(_so);
