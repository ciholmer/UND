...
public abstract class InfluentValveActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.framework.InfluentValveActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", new java.lang.Integer(18));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/framework/InfluentValveActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.framework.InfluentValveActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.framework.InfluentValveActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.framework.InfluentValveActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.framework.InfluentValveActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.framework.InfluentValveHelper.write(_out,getOutput());
				break;
			}
