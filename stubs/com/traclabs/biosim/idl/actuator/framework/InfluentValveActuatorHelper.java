...
public final class InfluentValveActuatorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/framework/InfluentValveActuator:1.0", "InfluentValveActuator");
	}
	...
	public static com.traclabs.biosim.idl.actuator.framework.InfluentValveActuator narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.actuator.framework.InfluentValveActuator)
		{
	...
	public static com.traclabs.biosim.idl.actuator.framework.InfluentValveActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/framework/InfluentValveActuator:1.0"))
			{
