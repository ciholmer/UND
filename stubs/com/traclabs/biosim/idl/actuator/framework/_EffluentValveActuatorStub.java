...
public class _EffluentValveActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.framework.EffluentValveActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.framework.EffluentValveActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			EffluentValveActuatorOperations _localServant = (EffluentValveActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.framework.EffluentValve getOutput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.framework.EffluentValve pEffluentValve)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.framework.EffluentValveHelper.write(_os,pEffluentValve);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		else
		{
			...
			try
			{
			_localServant.setOutput(pEffluentValve);
			}
			finally
			{
				_servant_postinvoke(_so);
