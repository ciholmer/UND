...
public abstract class PotableWaterInFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.PotableWaterInFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", new java.lang.Integer(3));
		m_opsHash.put ( "isMalfunctioning", new java.lang.Integer(4));
		m_opsHash.put ( "getMax", new java.lang.Integer(5));
		...
		m_opsHash.put ( "getOutput", new java.lang.Integer(12));
		...
		m_opsHash.put ( "setValue", new java.lang.Integer(22));
		...
		m_opsHash.put ( "getOutputModule", new java.lang.Integer(27));
		m_opsHash.put ( "getMin", new java.lang.Integer(28));
		m_opsHash.put ( "getMalfunctions", new java.lang.Integer(29));
		m_opsHash.put ( "fixAllMalfunctions", new java.lang.Integer(30));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/water/PotableWaterInFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.water.PotableWaterInFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.water.PotableWaterInFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.water.PotableWaterInFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.water.PotableWaterInFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 3: // setOutput
			{
				com.traclabs.biosim.idl.simulation.water.PotableWaterConsumer _arg0=com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerHelper.read(_input);
				int _arg1=_input.read_long();
				_out = handler.createReply();
				setOutput(_arg0,_arg1);
				break;
			}
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerHelper.write(_out,getOutput());
				break;
			}
