...
public class _DirtyWaterInFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			DirtyWaterInFlowRateActuatorOperations _localServant = (DirtyWaterInFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerHelper.write(_os,pConsumer);
	...
	public com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumer _result = com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			DirtyWaterInFlowRateActuatorOperations _localServant = (DirtyWaterInFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumer _result;			try
			{
