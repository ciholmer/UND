...
public abstract class WaterRSActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.WaterRSActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getOutputModule", new java.lang.Integer(25));
		...
		m_opsHash.put ( "setOutput", new java.lang.Integer(29));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/water/WaterRSActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.water.WaterRSActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.water.WaterRSActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.water.WaterRSActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.water.WaterRSActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.water.WaterRSHelper.write(_out,getOutput());
				break;
			}
			...
			case 29: // setOutput
			{
				com.traclabs.biosim.idl.simulation.water.WaterRS _arg0=com.traclabs.biosim.idl.simulation.water.WaterRSHelper.read(_input);
				_out = handler.createReply();
				setOutput(_arg0);
				break;
			}
