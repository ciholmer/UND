...
public class _PotableWaterInFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.water.PotableWaterInFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.water.PotableWaterInFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			PotableWaterInFlowRateActuatorOperations _localServant = (PotableWaterInFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.water.PotableWaterConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerHelper.write(_os,pConsumer);
		...
		else
		{
			...
			try
			{
			_localServant.setOutput(pConsumer,pIndex);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public com.traclabs.biosim.idl.simulation.water.PotableWaterConsumer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.water.PotableWaterConsumer _result = com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			PotableWaterInFlowRateActuatorOperations _localServant = (PotableWaterInFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.water.PotableWaterConsumer _result;			try
			{
