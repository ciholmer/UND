...
public abstract class PotableWaterOutFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.PotableWaterOutFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getIndex", new java.lang.Integer(20));
		m_opsHash.put ( "setValue", new java.lang.Integer(21));
		...
		m_opsHash.put ( "setOutput", new java.lang.Integer(30));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/water/PotableWaterOutFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.water.PotableWaterOutFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.water.PotableWaterOutFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.water.PotableWaterOutFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.water.PotableWaterOutFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.water.PotableWaterProducerHelper.write(_out,getOutput());
				break;
			}
			...
			case 30: // setOutput
			{
				com.traclabs.biosim.idl.simulation.water.PotableWaterProducer _arg0=com.traclabs.biosim.idl.simulation.water.PotableWaterProducerHelper.read(_input);
