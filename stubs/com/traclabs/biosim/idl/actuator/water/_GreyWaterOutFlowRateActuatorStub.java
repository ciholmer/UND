...
public class _GreyWaterOutFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			GreyWaterOutFlowRateActuatorOperations _localServant = (GreyWaterOutFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.water.GreyWaterProducer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.water.GreyWaterProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
