...
public abstract class GreyWaterInFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", new java.lang.Integer(4));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/water/GreyWaterInFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 4: // setOutput
			{
				com.traclabs.biosim.idl.simulation.water.GreyWaterConsumer _arg0=com.traclabs.biosim.idl.simulation.water.GreyWaterConsumerHelper.read(_input);
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.water.GreyWaterConsumerHelper.write(_out,getOutput());
				break;
			}
