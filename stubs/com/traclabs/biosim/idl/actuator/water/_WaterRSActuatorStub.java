...
public class _WaterRSActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.water.WaterRSActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.water.WaterRSActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			WaterRSActuatorOperations _localServant = (WaterRSActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.water.WaterRS getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.water.WaterRS _result = com.traclabs.biosim.idl.simulation.water.WaterRSHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			WaterRSActuatorOperations _localServant = (WaterRSActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.water.WaterRS _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.water.WaterRS source)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.water.WaterRSHelper.write(_os,source);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
