...
public class _GreyWaterInFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			GreyWaterInFlowRateActuatorOperations _localServant = (GreyWaterInFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.water.GreyWaterConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.water.GreyWaterConsumerHelper.write(_os,pConsumer);
	...
	public com.traclabs.biosim.idl.simulation.water.GreyWaterConsumer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.water.GreyWaterConsumer _result = com.traclabs.biosim.idl.simulation.water.GreyWaterConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			GreyWaterInFlowRateActuatorOperations _localServant = (GreyWaterInFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.water.GreyWaterConsumer _result;			try
			{
