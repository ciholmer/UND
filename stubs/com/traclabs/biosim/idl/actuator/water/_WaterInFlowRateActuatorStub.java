...
public class _WaterInFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.water.WaterInFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.water.WaterInFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			WaterInFlowRateActuatorOperations _localServant = (WaterInFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.water.WaterConsumer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.water.WaterConsumer _result = com.traclabs.biosim.idl.simulation.water.WaterConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			WaterInFlowRateActuatorOperations _localServant = (WaterInFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.water.WaterConsumer _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.water.WaterConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.water.WaterConsumerHelper.write(_os,pConsumer);
