...
public class _PotableWaterOutFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.water.PotableWaterOutFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.water.PotableWaterOutFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			PotableWaterOutFlowRateActuatorOperations _localServant = (PotableWaterOutFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.water.PotableWaterProducer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.water.PotableWaterProducer _result = com.traclabs.biosim.idl.simulation.water.PotableWaterProducerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			PotableWaterOutFlowRateActuatorOperations _localServant = (PotableWaterOutFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.water.PotableWaterProducer _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.water.PotableWaterProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.water.PotableWaterProducerHelper.write(_os,pProducer);
