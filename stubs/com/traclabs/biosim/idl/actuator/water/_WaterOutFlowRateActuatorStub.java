...
public class _WaterOutFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.water.WaterOutFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.water.WaterOutFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			WaterOutFlowRateActuatorOperations _localServant = (WaterOutFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.water.WaterProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
	...
	public com.traclabs.biosim.idl.simulation.water.WaterProducer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
