...
public abstract class GreyWaterOutFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", new java.lang.Integer(17));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/water/GreyWaterOutFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.water.GreyWaterProducerHelper.write(_out,getOutput());
				break;
			}
			...
			case 17: // setOutput
			{
				com.traclabs.biosim.idl.simulation.water.GreyWaterProducer _arg0=com.traclabs.biosim.idl.simulation.water.GreyWaterProducerHelper.read(_input);
