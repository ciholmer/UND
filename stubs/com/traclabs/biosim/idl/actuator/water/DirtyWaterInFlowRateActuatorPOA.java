...
public abstract class DirtyWaterInFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", new java.lang.Integer(6));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/water/DirtyWaterInFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 6: // setOutput
			{
				com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumer _arg0=com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerHelper.read(_input);
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerHelper.write(_out,getOutput());
				break;
			}
