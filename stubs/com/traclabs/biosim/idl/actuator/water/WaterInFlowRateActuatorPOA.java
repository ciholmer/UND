...
public abstract class WaterInFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.WaterInFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", new java.lang.Integer(28));
		m_opsHash.put ( "getMalfunctions", new java.lang.Integer(29));
		m_opsHash.put ( "fixAllMalfunctions", new java.lang.Integer(30));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/water/WaterInFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.water.WaterInFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.water.WaterInFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.water.WaterInFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.water.WaterInFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.water.WaterConsumerHelper.write(_out,getOutput());
				break;
			}
			...
			case 28: // setOutput
			{
				com.traclabs.biosim.idl.simulation.water.WaterConsumer _arg0=com.traclabs.biosim.idl.simulation.water.WaterConsumerHelper.read(_input);
