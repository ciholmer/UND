...
public abstract class WaterOutFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.WaterOutFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", new java.lang.Integer(7));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/water/WaterOutFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.water.WaterOutFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.water.WaterOutFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.water.WaterOutFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.water.WaterOutFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 7: // setOutput
			{
				com.traclabs.biosim.idl.simulation.water.WaterProducer _arg0=com.traclabs.biosim.idl.simulation.water.WaterProducerHelper.read(_input);
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.water.WaterProducerHelper.write(_out,getOutput());
				break;
			}
