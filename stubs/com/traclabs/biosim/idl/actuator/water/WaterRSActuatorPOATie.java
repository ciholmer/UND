...
public class WaterRSActuatorPOATie
	extends WaterRSActuatorPOA
{
	private WaterRSActuatorOperations _delegate;

	private POA _poa;
	public WaterRSActuatorPOATie(WaterRSActuatorOperations delegate)
	{
		_delegate = delegate;
	}
	public WaterRSActuatorPOATie(WaterRSActuatorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public WaterRSActuatorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(WaterRSActuatorOperations delegate)
	{
		_delegate = delegate;
	}
