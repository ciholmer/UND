...
public class AquaculturePSActuatorPOATie
	extends AquaculturePSActuatorPOA
{
	private AquaculturePSActuatorOperations _delegate;

	private POA _poa;
	public AquaculturePSActuatorPOATie(AquaculturePSActuatorOperations delegate)
	{
		_delegate = delegate;
	}
	public AquaculturePSActuatorPOATie(AquaculturePSActuatorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public AquaculturePSActuatorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(AquaculturePSActuatorOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.setEnableFailure(pValue);
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.food.AquaculturePS source)
	{
...
_delegate.maintain();
	...
	public com.traclabs.biosim.idl.simulation.food.AquaculturePS getOutput()
	{
