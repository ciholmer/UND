...
public class BiomassInFlowRateActuatorPOATie
	extends BiomassInFlowRateActuatorPOA
{
	private BiomassInFlowRateActuatorOperations _delegate;

	private POA _poa;
	public BiomassInFlowRateActuatorPOATie(BiomassInFlowRateActuatorOperations delegate)
	{
		_delegate = delegate;
	}
	public BiomassInFlowRateActuatorPOATie(BiomassInFlowRateActuatorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public BiomassInFlowRateActuatorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(BiomassInFlowRateActuatorOperations delegate)
	{
		_delegate = delegate;
	}
