...
public class _BiomassInFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.food.BiomassInFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.food.BiomassInFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			BiomassInFlowRateActuatorOperations _localServant = (BiomassInFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.food.BiomassConsumer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.food.BiomassConsumer _result = com.traclabs.biosim.idl.simulation.food.BiomassConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassInFlowRateActuatorOperations _localServant = (BiomassInFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.BiomassConsumer _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.food.BiomassConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.food.BiomassConsumerHelper.write(_os,pConsumer);
