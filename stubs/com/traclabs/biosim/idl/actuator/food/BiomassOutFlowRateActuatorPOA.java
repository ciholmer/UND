...
public abstract class BiomassOutFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.food.BiomassOutFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", new java.lang.Integer(14));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/food/BiomassOutFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.food.BiomassOutFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.food.BiomassOutFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.food.BiomassOutFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.food.BiomassOutFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.food.BiomassProducerHelper.write(_out,getOutput());
				break;
			}
			...
			case 14: // setOutput
			{
				com.traclabs.biosim.idl.simulation.food.BiomassProducer _arg0=com.traclabs.biosim.idl.simulation.food.BiomassProducerHelper.read(_input);
