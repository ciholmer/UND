...
public class _ShelfActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.food.ShelfActuator
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/food/ShelfActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.food.ShelfActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			ShelfActuatorOperations _localServant = (ShelfActuatorOperations)_so.servant;
			float _result;			try
			{
