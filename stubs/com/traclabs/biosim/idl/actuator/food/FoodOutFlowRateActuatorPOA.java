...
public abstract class FoodOutFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.food.FoodOutFlowRateActuatorOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/food/FoodOutFlowRateActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.food.FoodOutFlowRateActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.food.FoodOutFlowRateActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.food.FoodOutFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.food.FoodOutFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.food.FoodProducerHelper.write(_out,getOutput());
				break;
			}
			...
			case 14: // setOutput
			{
				com.traclabs.biosim.idl.simulation.food.FoodProducer _arg0=com.traclabs.biosim.idl.simulation.food.FoodProducerHelper.read(_input);
