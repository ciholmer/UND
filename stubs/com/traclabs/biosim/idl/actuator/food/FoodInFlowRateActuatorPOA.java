...
public abstract class FoodInFlowRateActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.food.FoodInFlowRateActuatorOperations
{
	...
	public com.traclabs.biosim.idl.actuator.food.FoodInFlowRateActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.food.FoodInFlowRateActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.food.FoodConsumerHelper.write(_out,getOutput());
				break;
			}
			...
			case 17: // setOutput
			{
				com.traclabs.biosim.idl.simulation.food.FoodConsumer _arg0=com.traclabs.biosim.idl.simulation.food.FoodConsumerHelper.read(_input);
