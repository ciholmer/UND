...
public abstract class TankHarvestingActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.food.TankHarvestingActuatorOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/food/TankHarvestingActuator:1.0","IDL:com/traclabs/biosim/idl/actuator/food/ShelfActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.food.TankHarvestingActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.food.TankHarvestingActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.food.TankHarvestingActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.food.TankHarvestingActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.food.TankHelper.write(_out,getOutput());
				break;
			}
