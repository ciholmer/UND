...
public final class FoodInFlowRateActuatorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/food/FoodInFlowRateActuator:1.0", "FoodInFlowRateActuator");
	}
	...
	public static com.traclabs.biosim.idl.actuator.food.FoodInFlowRateActuator narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.actuator.food.FoodInFlowRateActuator)
		{
	...
	public static com.traclabs.biosim.idl.actuator.food.FoodInFlowRateActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/food/FoodInFlowRateActuator:1.0"))
			{
