...
public abstract class PlantingActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.food.PlantingActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setPlantType", new java.lang.Integer(23));
		...
		m_opsHash.put ( "getOutputModule", new java.lang.Integer(28));
		m_opsHash.put ( "fixAllMalfunctions", new java.lang.Integer(29));
		m_opsHash.put ( "getMalfunctions", new java.lang.Integer(30));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/food/PlantingActuator:1.0","IDL:com/traclabs/biosim/idl/actuator/food/ShelfActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.food.PlantingActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.food.PlantingActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.food.PlantingActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.food.PlantingActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.food.ShelfHelper.write(_out,getOutput());
				break;
			}
