...
public class HarvestingActuatorPOATie
	extends HarvestingActuatorPOA
{
	private HarvestingActuatorOperations _delegate;

	private POA _poa;
	public HarvestingActuatorPOATie(HarvestingActuatorOperations delegate)
	{
		_delegate = delegate;
	}
	public HarvestingActuatorPOATie(HarvestingActuatorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public HarvestingActuatorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(HarvestingActuatorOperations delegate)
	{
		_delegate = delegate;
	}
