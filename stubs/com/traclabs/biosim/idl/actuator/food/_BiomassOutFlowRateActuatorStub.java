...
public class _BiomassOutFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.food.BiomassOutFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.food.BiomassOutFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			BiomassOutFlowRateActuatorOperations _localServant = (BiomassOutFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.food.BiomassProducer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.food.BiomassProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
