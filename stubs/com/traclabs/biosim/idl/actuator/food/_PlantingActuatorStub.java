...
public class _PlantingActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.food.PlantingActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.food.PlantingActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			PlantingActuatorOperations _localServant = (PlantingActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.food.Shelf getOutput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.food.BiomassPS source, int index)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.food.BiomassPSHelper.write(_os,source);
	...
	public void setPlantType(com.traclabs.biosim.idl.simulation.food.PlantType type)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setPlantType", true);
				com.traclabs.biosim.idl.simulation.food.PlantTypeHelper.write(_os,type);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setPlantType", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			PlantingActuatorOperations _localServant = (PlantingActuatorOperations)_so.servant;
			try
			{
			_localServant.setPlantType(type);
			}
			finally
			{
				_servant_postinvoke(_so);
