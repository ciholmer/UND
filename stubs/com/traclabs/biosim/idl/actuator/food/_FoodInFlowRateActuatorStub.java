...
public class _FoodInFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.food.FoodInFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.food.FoodInFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			FoodInFlowRateActuatorOperations _localServant = (FoodInFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.food.FoodConsumer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.food.FoodConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
