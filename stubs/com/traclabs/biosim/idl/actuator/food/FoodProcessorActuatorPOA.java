...
public abstract class FoodProcessorActuatorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.food.FoodProcessorActuatorOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/food/FoodProcessorActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public com.traclabs.biosim.idl.actuator.food.FoodProcessorActuator _this()
	{
		return com.traclabs.biosim.idl.actuator.food.FoodProcessorActuatorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.actuator.food.FoodProcessorActuator _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.actuator.food.FoodProcessorActuatorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.food.FoodProcessorHelper.write(_out,getOutput());
				break;
			}
			...
			case 25: // setOutput
			{
				com.traclabs.biosim.idl.simulation.food.FoodProcessor _arg0=com.traclabs.biosim.idl.simulation.food.FoodProcessorHelper.read(_input);
				_out = handler.createReply();
				setOutput(_arg0);
				break;
			}
