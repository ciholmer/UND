...
public class _SpawningActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.food.SpawningActuator
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/actuator/food/SpawningActuator:1.0","IDL:com/traclabs/biosim/idl/actuator/food/TankActuator:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/actuator/framework/GenericActuator:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.food.SpawningActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			SpawningActuatorOperations _localServant = (SpawningActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.food.Tank getOutput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.food.AquaculturePS source, int index)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.food.AquaculturePSHelper.write(_os,source);
		...
		else
		{
			...
			try
			{
			_localServant.setOutput(source,index);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void setFishType(com.traclabs.biosim.idl.simulation.food.FishType type)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setFishType", true);
				com.traclabs.biosim.idl.simulation.food.FishTypeHelper.write(_os,type);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "setFishType", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			SpawningActuatorOperations _localServant = (SpawningActuatorOperations)_so.servant;
			try
			{
			_localServant.setFishType(type);
			}
			finally
			{
				_servant_postinvoke(_so);
