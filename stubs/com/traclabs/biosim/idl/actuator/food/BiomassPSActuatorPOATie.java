...
public class BiomassPSActuatorPOATie
	extends BiomassPSActuatorPOA
{
	private BiomassPSActuatorOperations _delegate;

	private POA _poa;
	public BiomassPSActuatorPOATie(BiomassPSActuatorOperations delegate)
	{
		_delegate = delegate;
	}
	public BiomassPSActuatorPOATie(BiomassPSActuatorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public BiomassPSActuatorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(BiomassPSActuatorOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.setEnableFailure(pValue);
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.food.BiomassPS source)
	{
...
_delegate.maintain();
	...
	public com.traclabs.biosim.idl.simulation.food.BiomassPS getOutput()
	{
