...
public class _FoodProcessorActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.food.FoodProcessorActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.food.FoodProcessorActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			FoodProcessorActuatorOperations _localServant = (FoodProcessorActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.food.FoodProcessor getOutput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.food.FoodProcessor _result = com.traclabs.biosim.idl.simulation.food.FoodProcessorHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			FoodProcessorActuatorOperations _localServant = (FoodProcessorActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.FoodProcessor _result;			try
			{
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.food.FoodProcessor source)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.food.FoodProcessorHelper.write(_os,source);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		else
		{
			...
			try
			{
			_localServant.setOutput(source);
			}
			finally
			{
				_servant_postinvoke(_so);
