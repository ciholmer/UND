...
public class _FoodOutFlowRateActuatorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.actuator.food.FoodOutFlowRateActuator
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.actuator.food.FoodOutFlowRateActuatorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			FoodOutFlowRateActuatorOperations _localServant = (FoodOutFlowRateActuatorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.food.FoodProducer getOutput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setOutput(com.traclabs.biosim.idl.simulation.food.FoodProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
