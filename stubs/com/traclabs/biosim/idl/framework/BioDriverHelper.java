...
public final class BioDriverHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/framework/BioDriver:1.0", "BioDriver");
	}
	...
	public static com.traclabs.biosim.idl.framework.BioDriver narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.framework.BioDriver)
		{
	...
	public static com.traclabs.biosim.idl.framework.BioDriver narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/framework/BioDriver:1.0"))
			{
