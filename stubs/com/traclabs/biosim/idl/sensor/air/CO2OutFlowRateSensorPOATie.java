...
public class CO2OutFlowRateSensorPOATie
	extends CO2OutFlowRateSensorPOA
{
	private CO2OutFlowRateSensorOperations _delegate;

	private POA _poa;
	public CO2OutFlowRateSensorPOATie(CO2OutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public CO2OutFlowRateSensorPOATie(CO2OutFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public CO2OutFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(CO2OutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
