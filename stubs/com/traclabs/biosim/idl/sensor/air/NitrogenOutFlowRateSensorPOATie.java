...
public class NitrogenOutFlowRateSensorPOATie
	extends NitrogenOutFlowRateSensorPOA
{
	private NitrogenOutFlowRateSensorOperations _delegate;

	private POA _poa;
	public NitrogenOutFlowRateSensorPOATie(NitrogenOutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public NitrogenOutFlowRateSensorPOATie(NitrogenOutFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public com.traclabs.biosim.idl.sensor.air.NitrogenOutFlowRateSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.air.NitrogenOutFlowRateSensorHelper.narrow(_this_object(orb));
	}
	public NitrogenOutFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(NitrogenOutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
