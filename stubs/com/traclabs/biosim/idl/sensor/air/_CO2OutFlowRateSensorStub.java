...
public class _CO2OutFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.air.CO2OutFlowRateSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/air/CO2OutFlowRateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.air.CO2OutFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			CO2OutFlowRateSensorOperations _localServant = (CO2OutFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.CO2Producer getInput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.air.CO2Producer _result = com.traclabs.biosim.idl.simulation.air.CO2ProducerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			CO2OutFlowRateSensorOperations _localServant = (CO2OutFlowRateSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.CO2Producer _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.air.CO2Producer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.air.CO2ProducerHelper.write(_os,pProducer);
