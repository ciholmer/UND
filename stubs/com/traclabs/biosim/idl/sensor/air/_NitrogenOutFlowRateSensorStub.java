...
public class _NitrogenOutFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.air.NitrogenOutFlowRateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.air.NitrogenOutFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			NitrogenOutFlowRateSensorOperations _localServant = (NitrogenOutFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.NitrogenProducer getInput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setInput(com.traclabs.biosim.idl.simulation.air.NitrogenProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
