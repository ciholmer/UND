...
public final class MethaneOutFlowRateSensorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/air/MethaneOutFlowRateSensor:1.0", "MethaneOutFlowRateSensor");
	}
	...
	public static com.traclabs.biosim.idl.sensor.air.MethaneOutFlowRateSensor narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.sensor.air.MethaneOutFlowRateSensor)
		{
	...
	public static com.traclabs.biosim.idl.sensor.air.MethaneOutFlowRateSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/air/MethaneOutFlowRateSensor:1.0"))
			{
