...
public class H2OutFlowRateSensorPOATie
	extends H2OutFlowRateSensorPOA
{
	private H2OutFlowRateSensorOperations _delegate;

	private POA _poa;
	public H2OutFlowRateSensorPOATie(H2OutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public H2OutFlowRateSensorPOATie(H2OutFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public H2OutFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(H2OutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.clearMalfunction(id);
	...
	public void setInput(com.traclabs.biosim.idl.simulation.air.H2Producer pProducer, int pIndex)
	{
...
_delegate.setEnableFailure(pValue);
	...
	public com.traclabs.biosim.idl.simulation.air.H2Producer getInput()
	{
