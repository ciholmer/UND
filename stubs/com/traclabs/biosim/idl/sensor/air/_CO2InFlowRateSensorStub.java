...
public class _CO2InFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.air.CO2InFlowRateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.air.CO2InFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			CO2InFlowRateSensorOperations _localServant = (CO2InFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.CO2Consumer getInput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setInput(com.traclabs.biosim.idl.simulation.air.CO2Consumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
