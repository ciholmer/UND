...
public class H2InFlowRateSensorPOATie
	extends H2InFlowRateSensorPOA
{
	private H2InFlowRateSensorOperations _delegate;

	private POA _poa;
	public H2InFlowRateSensorPOATie(H2InFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public H2InFlowRateSensorPOATie(H2InFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public H2InFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(H2InFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
