...
public class _MethaneOutFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.air.MethaneOutFlowRateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.air.MethaneOutFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			MethaneOutFlowRateSensorOperations _localServant = (MethaneOutFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.air.MethaneProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.air.MethaneProducerHelper.write(_os,pProducer);
	...
	public com.traclabs.biosim.idl.simulation.air.MethaneProducer getInput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.air.MethaneProducer _result = com.traclabs.biosim.idl.simulation.air.MethaneProducerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			MethaneOutFlowRateSensorOperations _localServant = (MethaneOutFlowRateSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.MethaneProducer _result;			try
			{
