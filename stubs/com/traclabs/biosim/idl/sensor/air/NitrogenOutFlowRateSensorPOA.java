...
public abstract class NitrogenOutFlowRateSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.air.NitrogenOutFlowRateSensorOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.air.NitrogenProducerHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
