...
public class CO2InFlowRateSensorPOATie
	extends CO2InFlowRateSensorPOA
{
	private CO2InFlowRateSensorOperations _delegate;

	private POA _poa;
	public CO2InFlowRateSensorPOATie(CO2InFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public CO2InFlowRateSensorPOATie(CO2InFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public CO2InFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(CO2InFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
