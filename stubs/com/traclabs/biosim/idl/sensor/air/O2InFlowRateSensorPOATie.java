...
public class O2InFlowRateSensorPOATie
	extends O2InFlowRateSensorPOA
{
	private O2InFlowRateSensorOperations _delegate;

	private POA _poa;
	public O2InFlowRateSensorPOATie(O2InFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public O2InFlowRateSensorPOATie(O2InFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public O2InFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(O2InFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
