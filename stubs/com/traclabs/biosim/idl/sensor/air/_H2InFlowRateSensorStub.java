...
public class _H2InFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.air.H2InFlowRateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.air.H2InFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			H2InFlowRateSensorOperations _localServant = (H2InFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.air.H2Consumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
	...
	public com.traclabs.biosim.idl.simulation.air.H2Consumer getInput()
	{
		while(true)
		{
		if(! this._is_local())
