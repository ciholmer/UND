...
public final class MethaneInFlowRateSensorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/air/MethaneInFlowRateSensor:1.0", "MethaneInFlowRateSensor");
	}
	...
	public static com.traclabs.biosim.idl.sensor.air.MethaneInFlowRateSensor narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.sensor.air.MethaneInFlowRateSensor)
		{
	...
	public static com.traclabs.biosim.idl.sensor.air.MethaneInFlowRateSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/air/MethaneInFlowRateSensor:1.0"))
			{
