...
public class NitrogenInFlowRateSensorPOATie
	extends NitrogenInFlowRateSensorPOA
{
	private NitrogenInFlowRateSensorOperations _delegate;

	private POA _poa;
	public NitrogenInFlowRateSensorPOATie(NitrogenInFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public NitrogenInFlowRateSensorPOATie(NitrogenInFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public NitrogenInFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(NitrogenInFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
