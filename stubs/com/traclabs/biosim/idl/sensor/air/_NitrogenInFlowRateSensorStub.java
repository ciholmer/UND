...
public class _NitrogenInFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.air.NitrogenInFlowRateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.air.NitrogenInFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			NitrogenInFlowRateSensorOperations _localServant = (NitrogenInFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.NitrogenConsumer getInput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setInput(com.traclabs.biosim.idl.simulation.air.NitrogenConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
