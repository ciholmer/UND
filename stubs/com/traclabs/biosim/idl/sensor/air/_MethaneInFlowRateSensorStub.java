...
public class _MethaneInFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.air.MethaneInFlowRateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.air.MethaneInFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			MethaneInFlowRateSensorOperations _localServant = (MethaneInFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.air.MethaneConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
	...
	public com.traclabs.biosim.idl.simulation.air.MethaneConsumer getInput()
	{
		while(true)
		{
		if(! this._is_local())
