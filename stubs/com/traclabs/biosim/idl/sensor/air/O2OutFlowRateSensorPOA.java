...
public abstract class O2OutFlowRateSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.air.O2OutFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.air.O2OutFlowRateSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.air.O2OutFlowRateSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.air.O2OutFlowRateSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.air.O2OutFlowRateSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.air.O2ProducerHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
