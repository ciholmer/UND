...
public class _O2InFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.air.O2InFlowRateSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/air/O2InFlowRateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.air.O2InFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			O2InFlowRateSensorOperations _localServant = (O2InFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.O2Consumer getInput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setInput(com.traclabs.biosim.idl.simulation.air.O2Consumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
