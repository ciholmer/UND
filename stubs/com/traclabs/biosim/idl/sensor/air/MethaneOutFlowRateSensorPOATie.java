...
public class MethaneOutFlowRateSensorPOATie
	extends MethaneOutFlowRateSensorPOA
{
	private MethaneOutFlowRateSensorOperations _delegate;

	private POA _poa;
	public MethaneOutFlowRateSensorPOATie(MethaneOutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public MethaneOutFlowRateSensorPOATie(MethaneOutFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public MethaneOutFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(MethaneOutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
