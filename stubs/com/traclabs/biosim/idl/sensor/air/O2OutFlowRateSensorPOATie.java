...
public class O2OutFlowRateSensorPOATie
	extends O2OutFlowRateSensorPOA
{
	private O2OutFlowRateSensorOperations _delegate;

	private POA _poa;
	public O2OutFlowRateSensorPOATie(O2OutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public O2OutFlowRateSensorPOATie(O2OutFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public O2OutFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(O2OutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
