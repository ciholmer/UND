...
public abstract class GasConcentrationSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.environment.GasConcentrationSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getEnvironment", new java.lang.Integer(8));
		...
		m_opsHash.put ( "getGas", new java.lang.Integer(21));
	...
	public com.traclabs.biosim.idl.sensor.environment.GasConcentrationSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.environment.GasConcentrationSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.environment.GasConcentrationSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.environment.GasConcentrationSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 6: // setInput
			{
				...
				com.traclabs.biosim.idl.simulation.environment.EnvironmentStore _arg1=com.traclabs.biosim.idl.simulation.environment.EnvironmentStoreHelper.read(_input);
				_out = handler.createReply();
			...
			case 8: // getEnvironment
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.environment.SimEnvironmentHelper.write(_out,getEnvironment());
				break;
			}
			case 9: // randomFilter
			{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.environment.EnvironmentStoreHelper.write(_out,getGas());
				break;
			}
