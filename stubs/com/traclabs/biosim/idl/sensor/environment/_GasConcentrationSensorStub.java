...
public class _GasConcentrationSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.environment.GasConcentrationSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/environment/GasConcentrationSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.environment.GasConcentrationSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			GasConcentrationSensorOperations _localServant = (GasConcentrationSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.environment.SimEnvironment environment, com.traclabs.biosim.idl.simulation.environment.EnvironmentStore gas)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.environment.SimEnvironmentHelper.write(_os,environment);
				com.traclabs.biosim.idl.simulation.environment.EnvironmentStoreHelper.write(_os,gas);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		else
		{
			...
			try
			{
			_localServant.setInput(environment,gas);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public com.traclabs.biosim.idl.simulation.environment.SimEnvironment getEnvironment()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getEnvironment", true);
				_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getEnvironment", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			GasConcentrationSensorOperations _localServant = (GasConcentrationSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.environment.SimEnvironment _result;			try
			{
			_result = _localServant.getEnvironment();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public com.traclabs.biosim.idl.simulation.environment.EnvironmentStore getGas()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getGas", true);
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.environment.EnvironmentStore _result = com.traclabs.biosim.idl.simulation.environment.EnvironmentStoreHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getGas", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			GasConcentrationSensorOperations _localServant = (GasConcentrationSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.environment.EnvironmentStore _result;			try
			{
			_result = _localServant.getGas();
			}
			finally
			{
				_servant_postinvoke(_so);
