...
public class _GasMoleSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.environment.GasMoleSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/environment/GasMoleSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.environment.GasMoleSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			GasMoleSensorOperations _localServant = (GasMoleSensorOperations)_so.servant;
			float _result;			try
			{
