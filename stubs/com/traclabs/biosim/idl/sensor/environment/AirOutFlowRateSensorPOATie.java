...
public class AirOutFlowRateSensorPOATie
	extends AirOutFlowRateSensorPOA
{
	private AirOutFlowRateSensorOperations _delegate;

	private POA _poa;
	public AirOutFlowRateSensorPOATie(AirOutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public AirOutFlowRateSensorPOATie(AirOutFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public AirOutFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(AirOutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
