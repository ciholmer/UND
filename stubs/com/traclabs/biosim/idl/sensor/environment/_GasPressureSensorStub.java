...
public class _GasPressureSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.environment.GasPressureSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.environment.GasPressureSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			GasPressureSensorOperations _localServant = (GasPressureSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.environment.EnvironmentStore getInput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setInput(com.traclabs.biosim.idl.simulation.environment.EnvironmentStore source)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.environment.EnvironmentStoreHelper.write(_os,source);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
