...
public class AirInFlowRateSensorPOATie
	extends AirInFlowRateSensorPOA
{
	private AirInFlowRateSensorOperations _delegate;

	private POA _poa;
	public AirInFlowRateSensorPOATie(AirInFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public AirInFlowRateSensorPOATie(AirInFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public AirInFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(AirInFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
