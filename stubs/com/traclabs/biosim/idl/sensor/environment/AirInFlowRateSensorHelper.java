...
public final class AirInFlowRateSensorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/environment/AirInFlowRateSensor:1.0", "AirInFlowRateSensor");
	}
	...
	public static com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensor narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensor)
		{
	...
	public static com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/environment/AirInFlowRateSensor:1.0"))
			{
