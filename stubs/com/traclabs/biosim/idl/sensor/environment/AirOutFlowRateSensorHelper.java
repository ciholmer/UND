...
public final class AirOutFlowRateSensorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/environment/AirOutFlowRateSensor:1.0", "AirOutFlowRateSensor");
	}
	...
	public static com.traclabs.biosim.idl.sensor.environment.AirOutFlowRateSensor narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.sensor.environment.AirOutFlowRateSensor)
		{
	...
	public static com.traclabs.biosim.idl.sensor.environment.AirOutFlowRateSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/environment/AirOutFlowRateSensor:1.0"))
			{
