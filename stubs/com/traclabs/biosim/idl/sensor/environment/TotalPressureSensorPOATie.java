...
public class TotalPressureSensorPOATie
	extends TotalPressureSensorPOA
{
	private TotalPressureSensorOperations _delegate;

	private POA _poa;
	public TotalPressureSensorPOATie(TotalPressureSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public TotalPressureSensorPOATie(TotalPressureSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public TotalPressureSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(TotalPressureSensorOperations delegate)
	{
		_delegate = delegate;
	}
