...
public class _AirInFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/environment/AirInFlowRateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			AirInFlowRateSensorOperations _localServant = (AirInFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.environment.AirConsumer getInput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setInput(com.traclabs.biosim.idl.simulation.environment.AirConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
