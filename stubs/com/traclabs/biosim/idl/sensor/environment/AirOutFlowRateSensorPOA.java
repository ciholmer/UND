...
public abstract class AirOutFlowRateSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.environment.AirOutFlowRateSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", new java.lang.Integer(22));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/environment/AirOutFlowRateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.environment.AirOutFlowRateSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.environment.AirOutFlowRateSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.environment.AirOutFlowRateSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.environment.AirOutFlowRateSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.environment.AirProducerHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
			...
			case 22: // setInput
			{
				com.traclabs.biosim.idl.simulation.environment.AirProducer _arg0=com.traclabs.biosim.idl.simulation.environment.AirProducerHelper.read(_input);
