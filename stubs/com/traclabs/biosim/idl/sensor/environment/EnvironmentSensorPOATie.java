...
public class EnvironmentSensorPOATie
	extends EnvironmentSensorPOA
{
	private EnvironmentSensorOperations _delegate;

	private POA _poa;
	public EnvironmentSensorPOATie(EnvironmentSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public EnvironmentSensorPOATie(EnvironmentSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public EnvironmentSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(EnvironmentSensorOperations delegate)
	{
		_delegate = delegate;
	}
