...
public abstract class AirInFlowRateSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.environment.AirConsumerHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
