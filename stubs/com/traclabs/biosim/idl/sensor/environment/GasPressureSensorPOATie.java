...
public class GasPressureSensorPOATie
	extends GasPressureSensorPOA
{
	private GasPressureSensorOperations _delegate;

	private POA _poa;
	public GasPressureSensorPOATie(GasPressureSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public GasPressureSensorPOATie(GasPressureSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public GasPressureSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(GasPressureSensorOperations delegate)
	{
		_delegate = delegate;
	}
