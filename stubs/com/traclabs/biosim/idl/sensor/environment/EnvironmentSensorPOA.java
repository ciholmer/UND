...
public abstract class EnvironmentSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.environment.EnvironmentSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", new java.lang.Integer(28));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/environment/EnvironmentSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.environment.EnvironmentSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.environment.EnvironmentSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.environment.EnvironmentSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.environment.EnvironmentSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.environment.SimEnvironmentHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
