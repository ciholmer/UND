...
public abstract class GasPressureSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.environment.GasPressureSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", new java.lang.Integer(23));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/environment/GasPressureSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.environment.GasPressureSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.environment.GasPressureSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.environment.GasPressureSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.environment.GasPressureSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.environment.EnvironmentStoreHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
			...
			case 23: // setInput
			{
				com.traclabs.biosim.idl.simulation.environment.EnvironmentStore _arg0=com.traclabs.biosim.idl.simulation.environment.EnvironmentStoreHelper.read(_input);
				_out = handler.createReply();
				setInput(_arg0);
				break;
			}
