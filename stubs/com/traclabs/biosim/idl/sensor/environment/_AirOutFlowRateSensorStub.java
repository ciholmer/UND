...
public class _AirOutFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.environment.AirOutFlowRateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.environment.AirOutFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			AirOutFlowRateSensorOperations _localServant = (AirOutFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.environment.AirProducer getInput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.environment.AirProducer _result = com.traclabs.biosim.idl.simulation.environment.AirProducerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			AirOutFlowRateSensorOperations _localServant = (AirOutFlowRateSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.environment.AirProducer _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.environment.AirProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.environment.AirProducerHelper.write(_os,pProducer);
