...
public class _InfluentValveSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.framework.InfluentValveSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.framework.InfluentValveSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			InfluentValveSensorOperations _localServant = (InfluentValveSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.framework.InfluentValve getInput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setInput(com.traclabs.biosim.idl.simulation.framework.InfluentValve source)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.framework.InfluentValveHelper.write(_os,source);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
