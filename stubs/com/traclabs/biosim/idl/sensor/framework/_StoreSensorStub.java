...
public class _StoreSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.framework.StoreSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/framework/StoreSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.framework.StoreSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			StoreSensorOperations _localServant = (StoreSensorOperations)_so.servant;
			float _result;			try
			{
