...
public final class TimeSensorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/framework/TimeSensor:1.0", "TimeSensor");
	}
	...
	public static com.traclabs.biosim.idl.sensor.framework.TimeSensor narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.sensor.framework.TimeSensor)
		{
	...
	public static com.traclabs.biosim.idl.sensor.framework.TimeSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/framework/TimeSensor:1.0"))
			{
