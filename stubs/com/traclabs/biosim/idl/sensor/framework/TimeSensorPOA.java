...
public abstract class TimeSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.framework.TimeSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getValue", new java.lang.Integer(13));
		...
		m_opsHash.put ( "isFailureEnabled", new java.lang.Integer(20));
		m_opsHash.put ( "startMalfunction", new java.lang.Integer(21));
		m_opsHash.put ( "log", new java.lang.Integer(22));
		m_opsHash.put ( "getMin", new java.lang.Integer(23));
		m_opsHash.put ( "getInputModule", new java.lang.Integer(24));
		m_opsHash.put ( "getMalfunctions", new java.lang.Integer(25));
		m_opsHash.put ( "fixAllMalfunctions", new java.lang.Integer(26));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/framework/TimeSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.framework.TimeSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.framework.TimeSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.framework.TimeSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.framework.TimeSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 20: // isFailureEnabled
			{
				_out = handler.createReply();
				_out.write_boolean(isFailureEnabled());
				break;
			}
			case 21: // startMalfunction
			{
				com.traclabs.biosim.idl.framework.MalfunctionIntensity _arg0=com.traclabs.biosim.idl.framework.MalfunctionIntensityHelper.read(_input);
				com.traclabs.biosim.idl.framework.MalfunctionLength _arg1=com.traclabs.biosim.idl.framework.MalfunctionLengthHelper.read(_input);
				_out = handler.createReply();
