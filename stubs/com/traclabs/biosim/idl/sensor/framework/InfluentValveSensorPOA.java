...
public abstract class InfluentValveSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.framework.InfluentValveSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", new java.lang.Integer(18));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/framework/InfluentValveSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.framework.InfluentValveSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.framework.InfluentValveSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.framework.InfluentValveSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.framework.InfluentValveSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.framework.InfluentValveHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
			...
			case 18: // setInput
			{
				com.traclabs.biosim.idl.simulation.framework.InfluentValve _arg0=com.traclabs.biosim.idl.simulation.framework.InfluentValveHelper.read(_input);
				_out = handler.createReply();
				setInput(_arg0);
				break;
			}
