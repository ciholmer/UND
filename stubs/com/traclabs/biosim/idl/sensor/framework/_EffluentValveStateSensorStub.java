...
public class _EffluentValveStateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			EffluentValveStateSensorOperations _localServant = (EffluentValveStateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.framework.EffluentValve source)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.framework.EffluentValveHelper.write(_os,source);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
	...
	public com.traclabs.biosim.idl.simulation.framework.EffluentValve getInput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.framework.EffluentValve _result = com.traclabs.biosim.idl.simulation.framework.EffluentValveHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			EffluentValveStateSensorOperations _localServant = (EffluentValveStateSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.framework.EffluentValve _result;			try
			{
