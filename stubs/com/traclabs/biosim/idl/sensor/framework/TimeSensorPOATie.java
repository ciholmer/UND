...
public class TimeSensorPOATie
	extends TimeSensorPOA
{
	private TimeSensorOperations _delegate;

	private POA _poa;
	public TimeSensorPOATie(TimeSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public TimeSensorPOATie(TimeSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public TimeSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(TimeSensorOperations delegate)
	{
		_delegate = delegate;
	}
