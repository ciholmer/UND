...
public class StoreLevelSensorPOATie
	extends StoreLevelSensorPOA
{
	private StoreLevelSensorOperations _delegate;

	private POA _poa;
	public StoreLevelSensorPOATie(StoreLevelSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public StoreLevelSensorPOATie(StoreLevelSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public StoreLevelSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(StoreLevelSensorOperations delegate)
	{
		_delegate = delegate;
	}
