...
public final class StoreOverflowSensorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/framework/StoreOverflowSensor:1.0", "StoreOverflowSensor");
	}
	...
	public static com.traclabs.biosim.idl.sensor.framework.StoreOverflowSensor narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.sensor.framework.StoreOverflowSensor)
		{
	...
	public static com.traclabs.biosim.idl.sensor.framework.StoreOverflowSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/framework/StoreOverflowSensor:1.0"))
			{
