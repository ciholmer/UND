...
public final class InfluentValveStateSensorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/framework/InfluentValveStateSensor:1.0", "InfluentValveStateSensor");
	}
	...
	public static com.traclabs.biosim.idl.sensor.framework.InfluentValveStateSensor narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.sensor.framework.InfluentValveStateSensor)
		{
	...
	public static com.traclabs.biosim.idl.sensor.framework.InfluentValveStateSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/framework/InfluentValveStateSensor:1.0"))
			{
