...
public class _StoreOverflowSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.framework.StoreOverflowSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.framework.StoreOverflowSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			StoreOverflowSensorOperations _localServant = (StoreOverflowSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.framework.Store getInput()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.framework.Store _result = com.traclabs.biosim.idl.simulation.framework.StoreHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
	...
	public void setInput(com.traclabs.biosim.idl.simulation.framework.Store source)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.framework.StoreHelper.write(_os,source);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
