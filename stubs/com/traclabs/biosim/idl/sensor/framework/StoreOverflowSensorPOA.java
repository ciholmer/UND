...
public abstract class StoreOverflowSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.framework.StoreOverflowSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", new java.lang.Integer(13));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/framework/StoreOverflowSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/StoreSensor:1.0"};
	public com.traclabs.biosim.idl.sensor.framework.StoreOverflowSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.framework.StoreOverflowSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.framework.StoreOverflowSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.framework.StoreOverflowSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.framework.StoreHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
