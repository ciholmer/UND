...
public abstract class EffluentValveStateSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", new java.lang.Integer(6));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/framework/EffluentValveStateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/EffluentValveSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 6: // setInput
			{
				com.traclabs.biosim.idl.simulation.framework.EffluentValve _arg0=com.traclabs.biosim.idl.simulation.framework.EffluentValveHelper.read(_input);
				_out = handler.createReply();
				setInput(_arg0);
				break;
			}
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.framework.EffluentValveHelper.write(_out,getInput());
				break;
			}
			case 9: // randomFilter
			{
