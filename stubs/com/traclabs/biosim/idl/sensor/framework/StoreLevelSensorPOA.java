...
public abstract class StoreLevelSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.framework.StoreLevelSensorOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/framework/StoreLevelSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/StoreSensor:1.0"};
	public com.traclabs.biosim.idl.sensor.framework.StoreLevelSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.framework.StoreLevelSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.framework.StoreLevelSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.framework.StoreLevelSensorHelper.narrow(_this_object(orb));
	}
