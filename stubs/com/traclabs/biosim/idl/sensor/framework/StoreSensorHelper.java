...
public final class StoreSensorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/framework/StoreSensor:1.0", "StoreSensor");
	}
	...
	public static com.traclabs.biosim.idl.sensor.framework.StoreSensor narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.sensor.framework.StoreSensor)
		{
	...
	public static com.traclabs.biosim.idl.sensor.framework.StoreSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/framework/StoreSensor:1.0"))
			{
