...
public class InfluentValveSensorPOATie
	extends InfluentValveSensorPOA
{
	private InfluentValveSensorOperations _delegate;

	private POA _poa;
	public InfluentValveSensorPOATie(InfluentValveSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public InfluentValveSensorPOATie(InfluentValveSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public InfluentValveSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(InfluentValveSensorOperations delegate)
	{
		_delegate = delegate;
	}
