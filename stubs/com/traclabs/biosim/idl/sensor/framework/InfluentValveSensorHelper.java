...
public final class InfluentValveSensorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/framework/InfluentValveSensor:1.0", "InfluentValveSensor");
	}
	...
	public static com.traclabs.biosim.idl.sensor.framework.InfluentValveSensor narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.sensor.framework.InfluentValveSensor)
		{
	...
	public static com.traclabs.biosim.idl.sensor.framework.InfluentValveSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/framework/InfluentValveSensor:1.0"))
			{
