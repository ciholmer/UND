...
public class _CrewGroupAnyDeadSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.crew.CrewGroupAnyDeadSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.crew.CrewGroupAnyDeadSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			CrewGroupAnyDeadSensorOperations _localServant = (CrewGroupAnyDeadSensorOperations)_so.servant;
			float _result;			try
			{
