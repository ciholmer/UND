...
public class CrewGroupAnyDeadSensorPOATie
	extends CrewGroupAnyDeadSensorPOA
{
	private CrewGroupAnyDeadSensorOperations _delegate;

	private POA _poa;
	public CrewGroupAnyDeadSensorPOATie(CrewGroupAnyDeadSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public CrewGroupAnyDeadSensorPOATie(CrewGroupAnyDeadSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public com.traclabs.biosim.idl.sensor.crew.CrewGroupAnyDeadSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.crew.CrewGroupAnyDeadSensorHelper.narrow(_this_object(orb));
	}
	public CrewGroupAnyDeadSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(CrewGroupAnyDeadSensorOperations delegate)
	{
		_delegate = delegate;
	}
