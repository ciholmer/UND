...
public class CrewGroupSensorPOATie
	extends CrewGroupSensorPOA
{
	private CrewGroupSensorOperations _delegate;

	private POA _poa;
	public CrewGroupSensorPOATie(CrewGroupSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public CrewGroupSensorPOATie(CrewGroupSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public CrewGroupSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(CrewGroupSensorOperations delegate)
	{
		_delegate = delegate;
	}
