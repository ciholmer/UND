...
public abstract class CrewGroupSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.crew.CrewGroupSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getInputModule", new java.lang.Integer(25));
		m_opsHash.put ( "setInput", new java.lang.Integer(26));
		m_opsHash.put ( "getMalfunctions", new java.lang.Integer(27));
		m_opsHash.put ( "fixAllMalfunctions", new java.lang.Integer(28));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/crew/CrewGroupSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.crew.CrewGroupSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.crew.CrewGroupSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.crew.CrewGroupSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.crew.CrewGroupSensorHelper.narrow(_this_object(orb));
	}
