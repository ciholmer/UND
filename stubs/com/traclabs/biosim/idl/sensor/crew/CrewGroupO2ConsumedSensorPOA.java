...
public abstract class CrewGroupO2ConsumedSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.crew.CrewGroupO2ConsumedSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getMin", new java.lang.Integer(24));
		m_opsHash.put ( "setInput", new java.lang.Integer(25));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/crew/CrewGroupO2ConsumedSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/crew/CrewGroupSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.crew.CrewGroupO2ConsumedSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.crew.CrewGroupO2ConsumedSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.crew.CrewGroupO2ConsumedSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.crew.CrewGroupO2ConsumedSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.crew.CrewGroupHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
			...
			case 25: // setInput
			{
				com.traclabs.biosim.idl.simulation.crew.CrewGroup _arg0=com.traclabs.biosim.idl.simulation.crew.CrewGroupHelper.read(_input);
				_out = handler.createReply();
				setInput(_arg0);
				break;
			}
