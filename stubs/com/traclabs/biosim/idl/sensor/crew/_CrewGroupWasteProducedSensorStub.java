...
public class _CrewGroupWasteProducedSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.crew.CrewGroupWasteProducedSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.crew.CrewGroupWasteProducedSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			CrewGroupWasteProducedSensorOperations _localServant = (CrewGroupWasteProducedSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.crew.CrewGroup source)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.crew.CrewGroupHelper.write(_os,source);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
