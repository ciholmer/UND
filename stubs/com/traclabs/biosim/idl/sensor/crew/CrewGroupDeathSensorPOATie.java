...
public class CrewGroupDeathSensorPOATie
	extends CrewGroupDeathSensorPOA
{
	private CrewGroupDeathSensorOperations _delegate;

	private POA _poa;
	public CrewGroupDeathSensorPOATie(CrewGroupDeathSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public CrewGroupDeathSensorPOATie(CrewGroupDeathSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public CrewGroupDeathSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(CrewGroupDeathSensorOperations delegate)
	{
		_delegate = delegate;
	}
