...
public class PowerInFlowRateSensorPOATie
	extends PowerInFlowRateSensorPOA
{
	private PowerInFlowRateSensorOperations _delegate;

	private POA _poa;
	public PowerInFlowRateSensorPOATie(PowerInFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public PowerInFlowRateSensorPOATie(PowerInFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public PowerInFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(PowerInFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
