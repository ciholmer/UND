...
public class PowerOutFlowRateSensorPOATie
	extends PowerOutFlowRateSensorPOA
{
	private PowerOutFlowRateSensorOperations _delegate;

	private POA _poa;
	public PowerOutFlowRateSensorPOATie(PowerOutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public PowerOutFlowRateSensorPOATie(PowerOutFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public PowerOutFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(PowerOutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
