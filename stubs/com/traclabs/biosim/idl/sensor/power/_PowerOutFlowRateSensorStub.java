...
public class _PowerOutFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			PowerOutFlowRateSensorOperations _localServant = (PowerOutFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.power.PowerProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.power.PowerProducerHelper.write(_os,pProducer);
	...
	public com.traclabs.biosim.idl.simulation.power.PowerProducer getInput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.power.PowerProducer _result = com.traclabs.biosim.idl.simulation.power.PowerProducerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			PowerOutFlowRateSensorOperations _localServant = (PowerOutFlowRateSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.power.PowerProducer _result;			try
			{
