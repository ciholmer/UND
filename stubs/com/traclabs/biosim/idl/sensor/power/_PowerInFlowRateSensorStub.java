...
public class _PowerInFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.power.PowerInFlowRateSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/power/PowerInFlowRateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.power.PowerInFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			PowerInFlowRateSensorOperations _localServant = (PowerInFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.power.PowerConsumer getInput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setInput(com.traclabs.biosim.idl.simulation.power.PowerConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
