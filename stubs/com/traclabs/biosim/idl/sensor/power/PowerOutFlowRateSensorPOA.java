...
public abstract class PowerOutFlowRateSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensorOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/power/PowerOutFlowRateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.power.PowerProducerHelper.write(_out,getInput());
				break;
			}
			case 9: // randomFilter
			{
