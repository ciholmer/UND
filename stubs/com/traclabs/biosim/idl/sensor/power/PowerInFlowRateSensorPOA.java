...
public abstract class PowerInFlowRateSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.power.PowerInFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.power.PowerInFlowRateSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.power.PowerInFlowRateSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.power.PowerInFlowRateSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.power.PowerInFlowRateSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.power.PowerConsumerHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
