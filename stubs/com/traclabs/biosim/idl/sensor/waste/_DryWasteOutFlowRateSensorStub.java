...
public class _DryWasteOutFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.waste.DryWasteOutFlowRateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.waste.DryWasteOutFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			DryWasteOutFlowRateSensorOperations _localServant = (DryWasteOutFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.waste.DryWasteProducer getInput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.waste.DryWasteProducer _result = com.traclabs.biosim.idl.simulation.waste.DryWasteProducerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			DryWasteOutFlowRateSensorOperations _localServant = (DryWasteOutFlowRateSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.waste.DryWasteProducer _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.waste.DryWasteProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.waste.DryWasteProducerHelper.write(_os,pProducer);
