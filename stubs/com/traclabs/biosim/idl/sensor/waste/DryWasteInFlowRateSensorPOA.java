...
public abstract class DryWasteInFlowRateSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.waste.DryWasteInFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.waste.DryWasteInFlowRateSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.waste.DryWasteInFlowRateSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.waste.DryWasteInFlowRateSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.waste.DryWasteInFlowRateSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.waste.DryWasteConsumerHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
			...
			case 12: // setInput
			{
				com.traclabs.biosim.idl.simulation.waste.DryWasteConsumer _arg0=com.traclabs.biosim.idl.simulation.waste.DryWasteConsumerHelper.read(_input);
