...
public class _DryWasteInFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.waste.DryWasteInFlowRateSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/waste/DryWasteInFlowRateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.waste.DryWasteInFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			DryWasteInFlowRateSensorOperations _localServant = (DryWasteInFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.waste.DryWasteConsumer getInput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.waste.DryWasteConsumer _result = com.traclabs.biosim.idl.simulation.waste.DryWasteConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			DryWasteInFlowRateSensorOperations _localServant = (DryWasteInFlowRateSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.waste.DryWasteConsumer _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.waste.DryWasteConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.waste.DryWasteConsumerHelper.write(_os,pConsumer);
