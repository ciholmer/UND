...
public class _PotableWaterInFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.water.PotableWaterInFlowRateSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/water/PotableWaterInFlowRateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.water.PotableWaterInFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			PotableWaterInFlowRateSensorOperations _localServant = (PotableWaterInFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
