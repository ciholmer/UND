...
public class _WaterOutFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.water.WaterOutFlowRateSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/water/WaterOutFlowRateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.water.WaterOutFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			WaterOutFlowRateSensorOperations _localServant = (WaterOutFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.water.WaterProducer getInput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.water.WaterProducer _result = com.traclabs.biosim.idl.simulation.water.WaterProducerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			WaterOutFlowRateSensorOperations _localServant = (WaterOutFlowRateSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.water.WaterProducer _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.water.WaterProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.water.WaterProducerHelper.write(_os,pProducer);
