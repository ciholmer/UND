...
public class _DirtyWaterInFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.water.DirtyWaterInFlowRateSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/water/DirtyWaterInFlowRateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.water.DirtyWaterInFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			DirtyWaterInFlowRateSensorOperations _localServant = (DirtyWaterInFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumer getInput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setInput(com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		...
		else
		{
			...
			try
			{
			_localServant.setInput(pConsumer,pIndex);
			}
			finally
			{
				_servant_postinvoke(_so);
