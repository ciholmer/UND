...
public abstract class DirtyWaterInFlowRateSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.water.DirtyWaterInFlowRateSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", new java.lang.Integer(12));
	...
	public com.traclabs.biosim.idl.sensor.water.DirtyWaterInFlowRateSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.water.DirtyWaterInFlowRateSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.water.DirtyWaterInFlowRateSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.water.DirtyWaterInFlowRateSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
