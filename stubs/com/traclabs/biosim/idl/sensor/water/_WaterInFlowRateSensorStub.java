...
public class _WaterInFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.water.WaterInFlowRateSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/water/WaterInFlowRateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.water.WaterInFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			WaterInFlowRateSensorOperations _localServant = (WaterInFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.water.WaterConsumer getInput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setInput(com.traclabs.biosim.idl.simulation.water.WaterConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
