...
public class _DirtyWaterOutFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.water.DirtyWaterOutFlowRateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.water.DirtyWaterOutFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			DirtyWaterOutFlowRateSensorOperations _localServant = (DirtyWaterOutFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.water.DirtyWaterProducer getInput()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.water.DirtyWaterProducer _result = com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			DirtyWaterOutFlowRateSensorOperations _localServant = (DirtyWaterOutFlowRateSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.water.DirtyWaterProducer _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.water.DirtyWaterProducer pProducer, int pIndex)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerHelper.write(_os,pProducer);
