...
public class _GreyWaterInFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.water.GreyWaterInFlowRateSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/water/GreyWaterInFlowRateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.water.GreyWaterInFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			GreyWaterInFlowRateSensorOperations _localServant = (GreyWaterInFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.water.GreyWaterConsumer getInput()
	{
		while(true)
		{
		if(! this._is_local())
	...
	public void setInput(com.traclabs.biosim.idl.simulation.water.GreyWaterConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
