...
public abstract class WaterInFlowRateSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.water.WaterInFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.water.WaterInFlowRateSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.water.WaterInFlowRateSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.water.WaterInFlowRateSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.water.WaterInFlowRateSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.water.WaterConsumerHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
