...
public class WaterInFlowRateSensorPOATie
	extends WaterInFlowRateSensorPOA
{
	private WaterInFlowRateSensorOperations _delegate;

	private POA _poa;
	public WaterInFlowRateSensorPOATie(WaterInFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public WaterInFlowRateSensorPOATie(WaterInFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public WaterInFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(WaterInFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
