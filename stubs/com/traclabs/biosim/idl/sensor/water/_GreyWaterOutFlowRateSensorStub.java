...
public class _GreyWaterOutFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.water.GreyWaterOutFlowRateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.water.GreyWaterOutFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			GreyWaterOutFlowRateSensorOperations _localServant = (GreyWaterOutFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.water.GreyWaterProducer getInput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.water.GreyWaterProducer _result = com.traclabs.biosim.idl.simulation.water.GreyWaterProducerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			GreyWaterOutFlowRateSensorOperations _localServant = (GreyWaterOutFlowRateSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.water.GreyWaterProducer _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.water.GreyWaterProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.water.GreyWaterProducerHelper.write(_os,pProducer);
		...
		else
		{
			...
			try
			{
			_localServant.setInput(pProducer,pIndex);
			}
			finally
			{
				_servant_postinvoke(_so);
