...
public class PlantDeathSensorPOATie
	extends PlantDeathSensorPOA
{
	private PlantDeathSensorOperations _delegate;

	private POA _poa;
	public PlantDeathSensorPOATie(PlantDeathSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public PlantDeathSensorPOATie(PlantDeathSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public PlantDeathSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(PlantDeathSensorOperations delegate)
	{
		_delegate = delegate;
	}
