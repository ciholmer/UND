...
public class _BiomassStoreWaterContentSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.food.BiomassStoreWaterContentSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.food.BiomassStoreWaterContentSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			BiomassStoreWaterContentSensorOperations _localServant = (BiomassStoreWaterContentSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public com.traclabs.biosim.idl.simulation.food.BiomassStore getInput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.food.BiomassStore _result = com.traclabs.biosim.idl.simulation.food.BiomassStoreHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			BiomassStoreWaterContentSensorOperations _localServant = (BiomassStoreWaterContentSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.BiomassStore _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.food.BiomassStore source)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.food.BiomassStoreHelper.write(_os,source);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
