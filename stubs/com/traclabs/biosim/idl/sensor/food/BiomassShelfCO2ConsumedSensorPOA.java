...
/**
 *	Generated from IDL interface "BiomassShelfCO2ConsumedSensor"
 *	@author JacORB IDL compiler V 2.2.3, 10-Dec-2005
 */


public abstract class BiomassShelfCO2ConsumedSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.BiomassShelfCO2ConsumedSensorOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "getTickLength", new java.lang.Integer(0));
		m_opsHash.put ( "setInput", new java.lang.Integer(1));
		...
		m_opsHash.put ( "getInput", new java.lang.Integer(8));
		...
		m_opsHash.put ( "getMin", new java.lang.Integer(25));
		m_opsHash.put ( "getInputModule", new java.lang.Integer(26));
		m_opsHash.put ( "fixAllMalfunctions", new java.lang.Integer(27));
		m_opsHash.put ( "getMalfunctions", new java.lang.Integer(28));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/food/BiomassShelfCO2ConsumedSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/food/ShelfSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.food.BiomassShelfCO2ConsumedSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.food.BiomassShelfCO2ConsumedSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.food.BiomassShelfCO2ConsumedSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.food.BiomassShelfCO2ConsumedSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 1: // setInput
			{
				com.traclabs.biosim.idl.simulation.food.BiomassPS _arg0=com.traclabs.biosim.idl.simulation.food.BiomassPSHelper.read(_input);
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.food.ShelfHelper.write(_out,getInput());
				break;
			}
			case 9: // randomFilter
			{
