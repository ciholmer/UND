...
public abstract class TimeTillSchoolClosureSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.TimeTillSchoolClosureSensorOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/food/TimeTillSchoolClosureSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/food/TankSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.food.TimeTillSchoolClosureSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.food.TimeTillSchoolClosureSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.food.TimeTillSchoolClosureSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.food.TimeTillSchoolClosureSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 1: // setInput
			{
				com.traclabs.biosim.idl.simulation.food.AquaculturePS _arg0=com.traclabs.biosim.idl.simulation.food.AquaculturePSHelper.read(_input);
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.food.TankHelper.write(_out,getInput());
				break;
			}
			case 9: // randomFilter
			{
