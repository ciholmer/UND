...
public class _FoodInFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.food.FoodInFlowRateSensor
{
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/food/FoodInFlowRateSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.food.FoodInFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			FoodInFlowRateSensorOperations _localServant = (FoodInFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.food.FoodConsumer pConsumer, int pIndex)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.food.FoodConsumerHelper.write(_os,pConsumer);
	...
	public com.traclabs.biosim.idl.simulation.food.FoodConsumer getInput()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.food.FoodConsumer _result = com.traclabs.biosim.idl.simulation.food.FoodConsumerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			FoodInFlowRateSensorOperations _localServant = (FoodInFlowRateSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.FoodConsumer _result;			try
			{
