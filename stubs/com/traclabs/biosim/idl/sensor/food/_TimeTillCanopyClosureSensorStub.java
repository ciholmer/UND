...
public class _TimeTillCanopyClosureSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.food.TimeTillCanopyClosureSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.food.TimeTillCanopyClosureSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			TimeTillCanopyClosureSensorOperations _localServant = (TimeTillCanopyClosureSensorOperations)_so.servant;
			float _result;			try
			{
