...
public class BiomassOutFlowRateSensorPOATie
	extends BiomassOutFlowRateSensorPOA
{
	private BiomassOutFlowRateSensorOperations _delegate;

	private POA _poa;
	public BiomassOutFlowRateSensorPOATie(BiomassOutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public BiomassOutFlowRateSensorPOATie(BiomassOutFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public BiomassOutFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(BiomassOutFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
