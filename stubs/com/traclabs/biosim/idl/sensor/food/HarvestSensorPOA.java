...
public abstract class HarvestSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.HarvestSensorOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/food/HarvestSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/food/ShelfSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.food.HarvestSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.food.HarvestSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.food.HarvestSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.food.HarvestSensorHelper.narrow(_this_object(orb));
	}
