...
public class FishDeathSensorPOATie
	extends FishDeathSensorPOA
{
	private FishDeathSensorOperations _delegate;

	private POA _poa;
	public FishDeathSensorPOATie(FishDeathSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public FishDeathSensorPOATie(FishDeathSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public FishDeathSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(FishDeathSensorOperations delegate)
	{
		_delegate = delegate;
	}
