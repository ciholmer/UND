...
public abstract class BiomassTotalWaterConsumedSensorPOA
extends org.omg.PortableServer.Servant
implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.BiomassTotalWaterConsumedSensorOperations
{
...
private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/food/BiomassTotalWaterConsumedSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/food/BiomassSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
public com.traclabs.biosim.idl.sensor.food.BiomassTotalWaterConsumedSensor _this()
{
	return com.traclabs.biosim.idl.sensor.food.BiomassTotalWaterConsumedSensorHelper.narrow(_this_object());
}
public com.traclabs.biosim.idl.sensor.food.BiomassTotalWaterConsumedSensor _this(org.omg.CORBA.ORB orb)
{
	return com.traclabs.biosim.idl.sensor.food.BiomassTotalWaterConsumedSensorHelper.narrow(_this_object(orb));
}
	...
	throws org.omg.CORBA.SystemException
{
	...
	switch ( opsIndex.intValue() )
	{
		...
		{
			_out = handler.createReply();
			com.traclabs.biosim.idl.simulation.food.BiomassPSHelper.write(_out,getInput());
			break;
		}
		case 9: // randomFilter
		{
