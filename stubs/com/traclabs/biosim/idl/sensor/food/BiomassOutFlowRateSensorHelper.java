...
public final class BiomassOutFlowRateSensorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/food/BiomassOutFlowRateSensor:1.0", "BiomassOutFlowRateSensor");
	}
	...
	public static com.traclabs.biosim.idl.sensor.food.BiomassOutFlowRateSensor narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.sensor.food.BiomassOutFlowRateSensor)
		{
	...
	public static com.traclabs.biosim.idl.sensor.food.BiomassOutFlowRateSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/food/BiomassOutFlowRateSensor:1.0"))
			{
