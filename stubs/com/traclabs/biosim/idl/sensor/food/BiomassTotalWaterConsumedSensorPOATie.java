...
public class BiomassTotalWaterConsumedSensorPOATie
extends BiomassTotalWaterConsumedSensorPOA
{
	private BiomassTotalWaterConsumedSensorOperations _delegate;

	private POA _poa;
	public BiomassTotalWaterConsumedSensorPOATie(BiomassTotalWaterConsumedSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public BiomassTotalWaterConsumedSensorPOATie(BiomassTotalWaterConsumedSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public BiomassTotalWaterConsumedSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(BiomassTotalWaterConsumedSensorOperations delegate)
	{
		_delegate = delegate;
	}
