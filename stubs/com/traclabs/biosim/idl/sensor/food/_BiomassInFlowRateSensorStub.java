...
public class _BiomassInFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.food.BiomassInFlowRateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.food.BiomassInFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			BiomassInFlowRateSensorOperations _localServant = (BiomassInFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.food.BiomassConsumer pConsumer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
	...
	public com.traclabs.biosim.idl.simulation.food.BiomassConsumer getInput()
	{
		while(true)
		{
		if(! this._is_local())
