...
public class TimeTillCanopyClosureSensorPOATie
	extends TimeTillCanopyClosureSensorPOA
{
	private TimeTillCanopyClosureSensorOperations _delegate;

	private POA _poa;
	public TimeTillCanopyClosureSensorPOATie(TimeTillCanopyClosureSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public TimeTillCanopyClosureSensorPOATie(TimeTillCanopyClosureSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public TimeTillCanopyClosureSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(TimeTillCanopyClosureSensorOperations delegate)
	{
		_delegate = delegate;
	}
