...
public class BiomassStoreSensorPOATie
	extends BiomassStoreSensorPOA
{
	private BiomassStoreSensorOperations _delegate;

	private POA _poa;
	public BiomassStoreSensorPOATie(BiomassStoreSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public BiomassStoreSensorPOATie(BiomassStoreSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public BiomassStoreSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(BiomassStoreSensorOperations delegate)
	{
		_delegate = delegate;
	}
