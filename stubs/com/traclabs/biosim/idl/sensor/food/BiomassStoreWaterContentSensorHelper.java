...
public final class BiomassStoreWaterContentSensorHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/food/BiomassStoreWaterContentSensor:1.0", "BiomassStoreWaterContentSensor");
	}
	...
	public static com.traclabs.biosim.idl.sensor.food.BiomassStoreWaterContentSensor narrow(final java.lang.Object obj)
	{
		if (obj instanceof com.traclabs.biosim.idl.sensor.food.BiomassStoreWaterContentSensor)
		{
	...
	public static com.traclabs.biosim.idl.sensor.food.BiomassStoreWaterContentSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/food/BiomassStoreWaterContentSensor:1.0"))
			{
