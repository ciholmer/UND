...
public class _TimeTillSchoolClosureSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.food.TimeTillSchoolClosureSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.food.TimeTillSchoolClosureSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			TimeTillSchoolClosureSensorOperations _localServant = (TimeTillSchoolClosureSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.food.AquaculturePS source, int index)
	{
		while(true)
		{
		if(! this._is_local())
		...
		else
		{
			...
			try
			{
			_localServant.setInput(source,index);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public com.traclabs.biosim.idl.simulation.food.Tank getInput()
	{
		while(true)
		{
		if(! this._is_local())
