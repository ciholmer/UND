...
public abstract class BiomassOutFlowRateSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.BiomassOutFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.food.BiomassOutFlowRateSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.food.BiomassOutFlowRateSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.food.BiomassOutFlowRateSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.food.BiomassOutFlowRateSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.food.BiomassProducerHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
