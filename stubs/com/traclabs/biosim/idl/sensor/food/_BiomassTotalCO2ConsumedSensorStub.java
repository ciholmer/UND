...
public class _BiomassTotalCO2ConsumedSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.food.BiomassTotalCO2ConsumedSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.food.BiomassTotalCO2ConsumedSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			BiomassTotalCO2ConsumedSensorOperations _localServant = (BiomassTotalCO2ConsumedSensorOperations)_so.servant;
			float _result;			try
			{
