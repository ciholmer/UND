...
public class BiomassInFlowRateSensorPOATie
	extends BiomassInFlowRateSensorPOA
{
	private BiomassInFlowRateSensorOperations _delegate;

	private POA _poa;
	public BiomassInFlowRateSensorPOATie(BiomassInFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public BiomassInFlowRateSensorPOATie(BiomassInFlowRateSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public com.traclabs.biosim.idl.sensor.food.BiomassInFlowRateSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.food.BiomassInFlowRateSensorHelper.narrow(_this_object(orb));
	}
	public BiomassInFlowRateSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(BiomassInFlowRateSensorOperations delegate)
	{
		_delegate = delegate;
	}
