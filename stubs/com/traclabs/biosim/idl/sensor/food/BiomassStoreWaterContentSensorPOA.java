...
public abstract class BiomassStoreWaterContentSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.BiomassStoreWaterContentSensorOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/food/BiomassStoreWaterContentSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/food/BiomassStoreSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.food.BiomassStoreWaterContentSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.food.BiomassStoreWaterContentSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.food.BiomassStoreWaterContentSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.food.BiomassStoreWaterContentSensorHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.food.BiomassStoreHelper.write(_out,getInput());
				break;
			}
			case 8: // randomFilter
			{
			...
			case 14: // setInput
			{
				com.traclabs.biosim.idl.simulation.food.BiomassStore _arg0=com.traclabs.biosim.idl.simulation.food.BiomassStoreHelper.read(_input);
				_out = handler.createReply();
				setInput(_arg0);
				break;
			}
