...
public class ShelfSensorPOATie
	extends ShelfSensorPOA
{
	private ShelfSensorOperations _delegate;

	private POA _poa;
	public ShelfSensorPOATie(ShelfSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public ShelfSensorPOATie(ShelfSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public void _delegate(ShelfSensorOperations delegate)
	{
		_delegate = delegate;
	}
