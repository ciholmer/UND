...
public class TankSensorPOATie
	extends TankSensorPOA
{
	private TankSensorOperations _delegate;

	private POA _poa;
	public TankSensorPOATie(TankSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public TankSensorPOATie(TankSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public TankSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(TankSensorOperations delegate)
	{
		_delegate = delegate;
	}
