...
public class BiomassTotalCO2ConsumedSensorPOATie
	extends BiomassTotalCO2ConsumedSensorPOA
{
	private BiomassTotalCO2ConsumedSensorOperations _delegate;

	private POA _poa;
	public BiomassTotalCO2ConsumedSensorPOATie(BiomassTotalCO2ConsumedSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public BiomassTotalCO2ConsumedSensorPOATie(BiomassTotalCO2ConsumedSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public BiomassTotalCO2ConsumedSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(BiomassTotalCO2ConsumedSensorOperations delegate)
	{
		_delegate = delegate;
	}
