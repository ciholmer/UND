...
public abstract class TankSensorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.TankSensorOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/sensor/food/TankSensor:1.0","IDL:com/traclabs/biosim/idl/sensor/framework/GenericSensor:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.sensor.food.TankSensor _this()
	{
		return com.traclabs.biosim.idl.sensor.food.TankSensorHelper.narrow(_this_object());
	}
	public com.traclabs.biosim.idl.sensor.food.TankSensor _this(org.omg.CORBA.ORB orb)
	{
		return com.traclabs.biosim.idl.sensor.food.TankSensorHelper.narrow(_this_object(orb));
	}
