...
public class HarvestSensorPOATie
	extends HarvestSensorPOA
{
	private HarvestSensorOperations _delegate;

	private POA _poa;
	public HarvestSensorPOATie(HarvestSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public HarvestSensorPOATie(HarvestSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public HarvestSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(HarvestSensorOperations delegate)
	{
		_delegate = delegate;
	}
