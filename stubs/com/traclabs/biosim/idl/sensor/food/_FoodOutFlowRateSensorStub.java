...
public class _FoodOutFlowRateSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements com.traclabs.biosim.idl.sensor.food.FoodOutFlowRateSensor
{
	...
	public final static java.lang.Class _opsClass = com.traclabs.biosim.idl.sensor.food.FoodOutFlowRateSensorOperations.class;
	public float getTickLength()
	{
		...
		else
		{
			...
			FoodOutFlowRateSensorOperations _localServant = (FoodOutFlowRateSensorOperations)_so.servant;
			float _result;			try
			{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.food.FoodProducer pProducer, int pIndex)
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				com.traclabs.biosim.idl.simulation.food.FoodProducerHelper.write(_os,pProducer);
	...
	public com.traclabs.biosim.idl.simulation.food.FoodProducer getInput()
	{
		while(true)
		{
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				com.traclabs.biosim.idl.simulation.food.FoodProducer _result = com.traclabs.biosim.idl.simulation.food.FoodProducerHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			FoodOutFlowRateSensorOperations _localServant = (FoodOutFlowRateSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.FoodProducer _result;			try
			{
