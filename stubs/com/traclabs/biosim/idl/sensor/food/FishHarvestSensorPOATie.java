...
public class FishHarvestSensorPOATie
	extends FishHarvestSensorPOA
{
	private FishHarvestSensorOperations _delegate;

	private POA _poa;
	public FishHarvestSensorPOATie(FishHarvestSensorOperations delegate)
	{
		_delegate = delegate;
	}
	public FishHarvestSensorPOATie(FishHarvestSensorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public FishHarvestSensorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(FishHarvestSensorOperations delegate)
	{
		_delegate = delegate;
	}
